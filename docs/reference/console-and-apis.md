...
| `POST /api/ge/okf/customize` | `ge okf customize` | Scaffold a variant OKF bundle from a base agent (system swaps, terminology rewrites, vertical policy overlay) and compile it against the base | `writes-repo` | `node` on PATH |
