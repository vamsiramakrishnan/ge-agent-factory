...
| [`building-simulators`](../../skills/building-simulators/) | `simulator_build` | `ge data synth`, `ge pipeline run`, `ge daemon start`, `ge systems profile`, `ge systems record`, `ge systems compare`, `ge systems mutation infer`, `ge systems mutation validate`, `ge systems mutation apply` | [`@ge/synthkit`](../../packages/synthkit/), [`@ge/byo-systems`](../../packages/byo-systems/) | [`synthetic-data.md`](synthetic-data.md), [`simulator-systems.md`](simulator-systems.md), [`bring-your-own-systems.md`](../cookbooks/bring-your-own-systems.md), [`cli.md`](cli.md) |
