...
| [OKF corpus](okf-corpus.html) | The committed `okf/` corpus that is the primary source of the catalog: bundle layout, provenance keys, the corpus-first sync (`bun run catalog`), and the `check-okf-primary` gate. |
