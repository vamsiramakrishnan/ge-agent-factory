...
Use Reference after you know what you are trying to do and need the exact command,
field, endpoint, file, stage, or contract. For task order, use
[Cookbooks](../cookbooks/). For the rationale behind the shape of the system, use
[Concepts](../concepts/).
...
| Change the use-case contract | [Spec schema](spec-schema.html) |
| Change portable knowledge output | [OKF](okf.html) |
| Debug generated ADK code | [Agent generation](agent-generation.html) |
| Add or validate a simulator pack | [Simulator systems](simulator-systems.html) |
| Wire a UI or automation against the backend | [Console & APIs](console-and-apis.html) |
| Navigate the operator UI | [Console Tour](console-tour.html) |
...
- Link to the cookbook when a reference page describes a full workflow.
