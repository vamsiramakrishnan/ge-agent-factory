"""Auto-generated fixture-backed tools for: ap_aging_analyzer"""
...
_CONTRACT_DOCUMENTS = [{"id":"ap-aging-analyzer-controls-playbook","title":"AP Aging Analyzer Controls Playbook","type":"policy","path":"documents/ap-aging-analyzer-controls-playbook.md","source_system_id":"bigquery"}]
...
def list_documents() -> dict[str, Any]:
    ...
    return {"documents": [{"id":"ap-aging-analyzer-controls-playbook","title":"AP Aging Analyzer Controls Playbook","type":"policy","path":"documents/ap-aging-analyzer-controls-playbook.md","wordCount":556}]}

def read_document(document_id: str) -> dict[str, Any]:
    """Read the full text of a document by its ID. Use for citing evidence."""
    docs = [{"id":"ap-aging-analyzer-controls-playbook","path":"documents/ap-aging-analyzer-controls-playbook.md","title":"AP Aging Analyzer Controls Playbook"}]
...
def search_documents(query: str = "") -> dict[str, Any]:
    ...
    results = []
    for doc_meta in [{"id":"ap-aging-analyzer-controls-playbook","path":"documents/ap-aging-analyzer-controls-playbook.md","title":"AP Aging Analyzer Controls Playbook"}]:
...
def lookup_ap_aging_analyzer_controls_playbook(section_anchor: str = "", document_id: str = "") -> dict[str, Any]:
    """Look up sections of the AP Aging Analyzer Controls Playbook to cite in narrative output, escalation rationale, and audit evidence."""
...
_AGENT_ID = _os.environ.get("GE_AGENT_ID", "ap_aging_analyzer")
# Registry server id this agent registers as (override via env if needed).
_MCP_SERVER = _os.environ.get("GE_MCP_SERVER", "ap-aging-analyzer")
