...
import { analyticsPack } from "../scripts/factory/packs/analytics.mjs";
import { contentCollaborationPack } from "../scripts/factory/packs/content-collaboration.mjs";
import { crmMarketingOpsPack } from "../scripts/factory/packs/crm-marketing-ops.mjs";
import { financeErpPack } from "../scripts/factory/packs/finance-erp.mjs";
import { hrEmployeeRecordsPack } from "../scripts/factory/packs/hr-employee-records.mjs";
import { identitySecurityPack } from "../scripts/factory/packs/identity-security.mjs";
import { itsmPack } from "../scripts/factory/packs/itsm.mjs";
import { learningTalentPack } from "../scripts/factory/packs/learning-talent.mjs";
import { procurementOpsPack } from "../scripts/factory/packs/procurement-ops.mjs";
import { digitalAssetPack } from "../scripts/factory/packs/digital-assets.mjs";
...
// into .ge/test/factory; a bare runner falls back to .ge/factory — but
...
test("factory worker parses payloads and dispatches release stages to Cloud Build", async () => {
  ...
  assert.deepEqual(deployPlan.commands[0][1].slice(0, 3), ["scripts/factory.mjs", "promotion-gate", "--dir"]);
