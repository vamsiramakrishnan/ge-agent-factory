...
async function main() {
  ...
  const source = resolve(flags.source || "apps/ge-demo-generator/src/use-case-source-map.generated.json");
  const outJson = resolve(flags.json || "apps/ge-demo-generator/artifacts/upstream-system-inventory.json");
  const outMd = resolve(flags.md || "apps/ge-demo-generator/artifacts/upstream-system-inventory.md");
