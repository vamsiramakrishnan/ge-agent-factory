...
const REGISTRY_PATH = "apps/ge-demo-generator/simulator-systems/registry.json";
...
async function main() {
  ...
  const packDir = join(root, "apps", "ge-demo-generator", "simulator-systems", id);
  ...
  const entry = {
    ...
    schemaPath: `apps/ge-demo-generator/simulator-systems/${id}/schema.json`,
    toolsPath: `apps/ge-demo-generator/simulator-systems/${id}/tools.json`,
    projectionPath: `apps/ge-demo-generator/simulator-systems/${id}/projection.json`,
    materializationPath: `apps/ge-demo-generator/simulator-systems/${id}/materialization.json`,
    workflowsPath: `apps/ge-demo-generator/simulator-systems/${id}/workflows.json`,
    seedPath: `apps/ge-demo-generator/simulator-systems/${id}/seed.json`,
    plugin: {
      runtime: "python",
