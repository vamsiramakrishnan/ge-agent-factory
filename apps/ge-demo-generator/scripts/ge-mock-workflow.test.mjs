...
import { __test } from "./ge-mock.mjs";
import { buildWorkflowFromPipeline } from "./ge-mock/agent-workflow.mjs";
import { ensureContractQueryTables } from "./ge-mock/core/contract-schema.mjs";

const { deriveAgentWorkflow, canonicalIntentToolName } = __test;
const SCRIPT_DIR = dirname(fileURLToPath(import.meta.url));
const GE_MOCK = join(SCRIPT_DIR, "ge-mock.mjs");
// ge-mock resolves its use-case catalog relative to cwd; run subprocesses from the
