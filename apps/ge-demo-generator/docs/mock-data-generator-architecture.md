...
```bash
ge-mock plan-data --dir <workspace> --usecase BenefitsAssistant
ge-mock package-oltp --dir <workspace> --target alloydb
ge-mock package-oltp --dir <workspace> --target firestore
ge-mock package-olap --dir <workspace> --target bigquery
ge-mock package-blobs --dir <workspace> --target gcs --formats pdf,docx,md
```
