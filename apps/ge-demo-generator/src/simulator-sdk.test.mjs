  ...
  simulators: [
    {
      ...
      family: "hr-talent",
      schemaPath: "apps/ge-demo-generator/simulator-systems/workday/schema.json",
      toolsPath: "apps/ge-demo-generator/simulator-systems/workday/tools.json",
      materializationPath: "apps/ge-demo-generator/simulator-systems/workday/materialization.json",
    },
  ],
};
