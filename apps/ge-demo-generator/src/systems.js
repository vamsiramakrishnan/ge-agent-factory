...
export function renderSystemPrompt() {
  return [
    ...
    "For ADK coding-agent guidance, treat https://adk.dev/tutorials/coding-with-ai/#agents-cli as the canonical public reference: Agents CLI skills are the official ADK coding skills for Antigravity, Gemini CLI, Claude Code, Cursor, and similar coding harnesses.",
    ...
    "For the full agent pipeline, use running-factory, building-simulators, and the ge-mock CLI. Source adapters may be local fixture-backed services during development and deployable API/MCP services when live cloud deployment is explicitly requested.",
