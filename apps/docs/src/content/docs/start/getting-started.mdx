...
structured fixes it knows about, and leaves the `ge` CLI plus <a href="/ge-agent-factory/reference/glossary/#harness" title="The local, LLM-driven &quot;does this generated agent actually match the spec?&quot;">harness</a> skills
