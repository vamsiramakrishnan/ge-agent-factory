...
The proven <a href="/ge-agent-factory/reference/glossary/#workspace" title="The on-disk folder for one generated agent (.ge/factory/workspaces/workspace-id/), with a workspace.json manifest describing what's in it.">workspace</a> this produces is a standard
...
2. **Understand which side of the <a href="/ge-agent-factory/reference/glossary/#build-boundary" title="The cutoff between building and previewing an agent locally and deploying it to your Google Cloud project.">build boundary</a> you're on.**
   ...
   <a href="/ge-agent-factory/reference/glossary/#handoff" title="The factory's release act — handing a locally proven workspace to the layer below: agents-cli → ADK Agent Engine → Gemini Enterprise.">handoff</a>. You can instead have the cloud factory do the building while
