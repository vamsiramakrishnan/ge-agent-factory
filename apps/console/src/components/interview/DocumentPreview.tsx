    ...
    <div className="rounded-md border border-outline-variant/40 bg-surface-container/40">
      <div className="flex items-start gap-2 px-3 py-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[10px] text-secondary">
            ...
            {doc.truncated && (
              <span className="rounded-full bg-amber-500/10 px-1.5 py-0.5 font-medium text-amber-700">truncated</span>
            )}
          </div>
        </div>
        <label className="flex shrink-0 cursor-pointer items-center gap-1.5 text-[11px] font-medium text-secondary">
          <input
            type="checkbox"
      ...
      {doc.note && (
        <div className="mx-3 mb-2 flex items-start gap-1.5 rounded bg-amber-500/10 px-2 py-1 text-[11px] text-amber-700">
          <Info className="mt-0.5 h-3 w-3 shrink-0" />
          <span>{doc.note}</span>
        </div>
      )}
      {open && (
        <pre className="mx-3 mb-3 max-h-56 overflow-auto rounded border border-outline-variant/30 bg-surface px-3 py-2 text-[11px] leading-snug text-secondary whitespace-pre-wrap">
