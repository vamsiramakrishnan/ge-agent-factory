/**
 * recipe.mjs — shared, deterministic data-generation library for simulator packs.
 * (Formerly apps/factory/scripts/lib/data-recipe.mjs.)
 *
 * One recipe contract, two realization tiers:
 *   - Snowfakery (high-fidelity, out-of-process): `toSnowfakeryYaml(recipe)`
 *     (lives in ./snowfakery.mjs with the other Snowfakery dialect renderers)
...
// Exported for ./snowfakery.mjs's recipe-dialect renderer, which realizes the same
// generator descriptors as Snowfakery fakes.
export function stringGeneratorFor(fieldName) {
...
// Exported for ./snowfakery.mjs (PK/code expressions share this prefix derivation).
export function codePrefix(fieldName) {
