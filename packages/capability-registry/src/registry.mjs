...
export const GE_COMMANDS = {
  ...
  "systems.bind": {
    id: "systems.bind", method: null, path: null,
    cli: "ge systems bind",
  ...
  "systems.bindings": {
    id: "systems.bindings", method: null, path: null,
  ...
  "systems.unbind": {
    id: "systems.unbind", method: null, path: null,
  ...
  "byo.doctor": {
    id: "byo.doctor", method: null, path: null,
    cli: "ge byo doctor",
