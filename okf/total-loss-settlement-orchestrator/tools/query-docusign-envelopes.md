...
description: Retrieve envelopes from DocuSign for the Total Loss Settlement Orchestrator workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve envelopes from DocuSign for the Total Loss Settlement Orchestrator workflow.
