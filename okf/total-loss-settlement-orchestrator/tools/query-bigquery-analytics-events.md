...
description: Retrieve analytics events from BigQuery for the Total Loss Settlement Orchestrator workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Total Loss Settlement Orchestrator workflow.
