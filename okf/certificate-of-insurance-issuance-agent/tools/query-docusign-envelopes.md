...
description: Retrieve envelopes from DocuSign for the Certificate of Insurance Issuance Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve envelopes from DocuSign for the Certificate of Insurance Issuance Agent workflow.
