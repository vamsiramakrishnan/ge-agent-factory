---
type: Agent Tool
title: lookup_liquidity_dashboard_controls_playbook
...
Look up sections of the Liquidity Dashboard Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_liquidity_dashboard_controls_playbook(section_anchor=<section_anchor>)
```
