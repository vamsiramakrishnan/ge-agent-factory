---
type: Agent Tool
title: lookup_feature_store_manager_runbook
...
Look up sections of the Feature Store Manager Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [feature_catalog_indexing](/workflow/feature-catalog-indexing.md)
- [usage_freshness_analysis](/workflow/usage-freshness-analysis.md)
- [reuse_recommendation](/workflow/reuse-recommendation.md)
- [lifecycle_management](/workflow/lifecycle-management.md)
...
```
lookup_feature_store_manager_runbook(section_anchor=<section_anchor>)
```
