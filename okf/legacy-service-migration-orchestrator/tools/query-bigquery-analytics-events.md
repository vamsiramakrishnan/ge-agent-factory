...
description: Retrieve analytics events from BigQuery for the Legacy Service Migration Orchestrator workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Legacy Service Migration Orchestrator workflow.
