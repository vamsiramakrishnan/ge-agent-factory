...
description: Retrieve network inventory items from Netcracker Service Orchestration for the Legacy Service Migration Orchestrator workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve network inventory items from Netcracker Service Orchestration for the Legacy Service Migration Orchestrator workflow.
