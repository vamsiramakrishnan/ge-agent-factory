---
type: Agent Tool
title: lookup_feature_flag_manager_runbook
...
Look up sections of the Feature Flag Manager Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [cleanup_reasoning](/workflow/cleanup-reasoning.md)
...
```
lookup_feature_flag_manager_runbook(section_anchor=<section_anchor>)
```
