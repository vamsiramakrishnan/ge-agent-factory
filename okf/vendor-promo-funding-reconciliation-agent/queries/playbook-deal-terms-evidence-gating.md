...
title: Cite the Vendor Promo Funding Reconciliation Agent Retail Execution Playbook ...
description: "Cite the Vendor Promo Funding Reconciliation Agent Retail Execution Playbook for every flagged gap, and additionally cite the Vendor Deal Terms & Claim Substantiation Manual whenever a cost_changes allowance record or claim-filing deadline is in play."
source_id: "playbook-deal-terms-evidence-gating"
...
# Cite the Vendor Promo Funding Reconciliation Agent Retail Execution Playbook for every flagged gap, and additionally cite the Vendor Deal Terms & Claim Substantiation Manual whenever a cost_changes allowance record or claim-filing deadline is in play.
