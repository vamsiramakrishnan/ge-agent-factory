---
type: Agent Tool
title: lookup_onboarding_tech_setup_orchestrator_runbook
...
Look up sections of the Onboarding Tech Setup Orchestrator Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_onboarding_tech_setup_orchestrator_runbook(section_anchor=<section_anchor>)
```
