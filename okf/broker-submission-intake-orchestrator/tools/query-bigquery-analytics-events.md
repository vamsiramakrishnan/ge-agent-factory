...
description: Retrieve analytics events from BigQuery for the Broker Submission Intake Orchestrator workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Broker Submission Intake Orchestrator workflow.
