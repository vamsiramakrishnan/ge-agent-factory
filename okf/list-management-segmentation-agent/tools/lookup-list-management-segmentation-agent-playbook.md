---
type: Agent Tool
title: lookup_list_management_segmentation_agent_playbook
...
Look up sections of the List Management & Segmentation Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [criteria_interpretation](/workflow/criteria-interpretation.md)
...
```
lookup_list_management_segmentation_agent_playbook(section_anchor=<section_anchor>)
```
