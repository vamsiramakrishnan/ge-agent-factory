---
type: Agent Tool
title: query_thomasnet_thomasnet_records
...
Retrieve thomasnet records from ThomasNet for the Supplier Discovery & Matching workflow.

- **Kind:** query
- **Source system:** [ThomasNet](/systems/thomasnet.md)
...
No explicit permission scopes declared; source-system access is tied to [ThomasNet](/systems/thomasnet.md).
...
```
query_thomasnet_thomasnet_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [ThomasNet](/systems/thomasnet.md)
