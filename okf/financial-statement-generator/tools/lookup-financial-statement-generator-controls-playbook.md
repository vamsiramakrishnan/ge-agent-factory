---
type: Agent Tool
title: lookup_financial_statement_generator_controls_playbook
...
Look up sections of the Financial Statement Generator Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_financial_statement_generator_controls_playbook(section_anchor=<section_anchor>)
```
