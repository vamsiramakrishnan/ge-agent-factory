---
type: Agent Tool
title: action_coupa_catalog_generate
...
Execute the generate step in Coupa catalog after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Coupa catalog](/systems/coupa-catalog.md)
- **API:** POST /api/coupa_catalog/generate
...
- May change Coupa catalog state because the spec classifies it as action.
...
- [Confirmation policy — action_coupa_catalog_generate](/policies/confirmation-action-coupa-catalog-generate.md)
...
- [edge_case_analysis_migration_plan](/workflow/edge-case-analysis-migration-plan.md)
...
```
action_coupa_catalog_generate(target_id=<target_id>, rationale=<rationale>)
```
...
- [Confirmation policy — action_coupa_catalog_generate](/policies/confirmation-action-coupa-catalog-generate.md)
- [Idempotency policy — action_coupa_catalog_generate](/policies/idempotency-action-coupa-catalog-generate.md)
