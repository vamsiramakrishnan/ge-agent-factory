---
type: Agent Tool
title: lookup_sourcing_channel_optimizer_policy_guide
...
Look up sections of the Sourcing Channel Optimizer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_sourcing_channel_optimizer_policy_guide(section_anchor=<section_anchor>)
```
