---
type: Agent Tool
title: lookup_ppc_bid_management_agent_playbook
...
Look up sections of the PPC Bid Management Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_ppc_bid_management_agent_playbook(section_anchor=<section_anchor>)
```
