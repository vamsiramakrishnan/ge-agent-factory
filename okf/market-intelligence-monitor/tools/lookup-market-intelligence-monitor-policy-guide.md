---
type: Agent Tool
title: lookup_market_intelligence_monitor_policy_guide
...
Look up sections of the Market Intelligence Monitor Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_market_intelligence_monitor_policy_guide(section_anchor=<section_anchor>)
```
