...
Execute the sync step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/sync
...
```
action_workday_sync(target_id=<target_id>, rationale=<rationale>)
```
