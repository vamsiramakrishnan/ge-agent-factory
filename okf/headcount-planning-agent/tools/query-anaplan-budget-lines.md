...
Retrieve budget lines from Anaplan for the Headcount Planning Agent workflow.
...
- [fully_loaded_cost_modeling](/workflow/fully-loaded-cost-modeling.md)
- [justification_assessment](/workflow/justification-assessment.md)
- [plan_delivery](/workflow/plan-delivery.md)
