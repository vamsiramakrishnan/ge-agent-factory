---
type: Agent Tool
title: lookup_headcount_planning_agent_controls_playbook
...
Look up sections of the Headcount Planning Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_headcount_planning_agent_controls_playbook(section_anchor=<section_anchor>)
```
