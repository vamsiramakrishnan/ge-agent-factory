...
description: "Retrieve analytics events from BigQuery for the Mid-Term Cancellation Retention Agent workflow."
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Mid-Term Cancellation Retention Agent workflow.
