---
type: Agent Tool
title: lookup_board_deck_generator_controls_playbook
...
Look up sections of the Board Deck Generator Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_board_deck_generator_controls_playbook(section_anchor=<section_anchor>)
```
