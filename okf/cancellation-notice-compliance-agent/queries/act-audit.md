...
description: "Execute the file step in Guidewire BillingCenter with a full audit trail, and escalate exceptions to the Billing Supervisor."
source_id: "act-audit"
...
# Execute the file step in Guidewire BillingCenter with a full audit trail, and escalate exceptions to the Billing Supervisor.
