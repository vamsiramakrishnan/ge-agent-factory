...
description: Retrieve analytics events from BigQuery for the Cancellation Notice Compliance Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Cancellation Notice Compliance Agent workflow.
