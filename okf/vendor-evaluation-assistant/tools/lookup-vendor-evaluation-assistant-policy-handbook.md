---
type: Agent Tool
title: lookup_vendor_evaluation_assistant_policy_handbook
...
Look up sections of the Vendor Evaluation Assistant Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [proposal_analysis](/workflow/proposal-analysis.md)
...
```
lookup_vendor_evaluation_assistant_policy_handbook(section_anchor=<section_anchor>)
```
