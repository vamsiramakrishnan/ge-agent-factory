---
type: Agent Tool
title: lookup_resume_screening_shortlisting_policy_handbook
...
Look up sections of the Resume Screening & Shortlisting Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [deep_analysis_scoring](/workflow/deep-analysis-scoring.md)
...
```
lookup_resume_screening_shortlisting_policy_handbook(section_anchor=<section_anchor>)
```
