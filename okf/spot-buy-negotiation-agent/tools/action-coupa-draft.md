...
Execute the draft step in Coupa after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Coupa](/systems/coupa.md)
- **API:** POST /api/coupa/draft
...
```
action_coupa_draft(target_id=<target_id>, rationale=<rationale>)
```
