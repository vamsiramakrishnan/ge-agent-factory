---
type: Agent Tool
title: query_email_api_email_api_records
...
Retrieve email api records from Email API for the Spot Buy Negotiation Agent workflow.

- **Kind:** query
- **Source system:** [Email API](/systems/email-api.md)
...
No explicit permission scopes declared; source-system access is tied to [Email API](/systems/email-api.md).
...
```
query_email_api_email_api_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Email API](/systems/email-api.md)
