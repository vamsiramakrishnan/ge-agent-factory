---
type: Agent Tool
title: lookup_spot_buy_negotiation_agent_policy_guide
...
Look up sections of the Spot Buy Negotiation Agent Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_spot_buy_negotiation_agent_policy_guide(section_anchor=<section_anchor>)
```
