...
description: Retrieve product catalog entries from Salesforce Commerce Cloud for the Site Search Relevance Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve product catalog entries from Salesforce Commerce Cloud for the Site Search Relevance Engine workflow.
