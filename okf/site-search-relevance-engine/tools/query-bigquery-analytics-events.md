...
description: Retrieve analytics events from BigQuery for the Site Search Relevance Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Site Search Relevance Engine workflow.
