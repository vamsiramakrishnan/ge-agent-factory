...
description: Retrieve cart events from Salesforce Commerce Cloud for the Site Search Relevance Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cart events from Salesforce Commerce Cloud for the Site Search Relevance Engine workflow.
