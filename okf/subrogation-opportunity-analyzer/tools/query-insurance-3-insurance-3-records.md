...
description: Retrieve insurance 3 records from INSURANCE 3 for the Subrogation Opportunity Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve insurance 3 records from INSURANCE 3 for the Subrogation Opportunity Analyzer workflow.
