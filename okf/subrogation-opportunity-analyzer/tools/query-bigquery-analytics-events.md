...
description: Retrieve analytics events from BigQuery for the Subrogation Opportunity Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Subrogation Opportunity Analyzer workflow.
