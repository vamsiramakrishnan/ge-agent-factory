---
type: Agent Tool
title: lookup_job_architecture_sync_agent_policy_handbook
...
Look up sections of the Job Architecture Sync Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [auto_sync_audit](/workflow/auto-sync-audit.md)
...
```
lookup_job_architecture_sync_agent_policy_handbook(section_anchor=<section_anchor>)
```
