...
Execute the publish step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/publish
...
```
action_workday_publish(target_id=<target_id>, rationale=<rationale>)
```
