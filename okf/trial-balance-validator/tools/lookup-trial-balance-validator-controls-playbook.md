---
type: Agent Tool
title: lookup_trial_balance_validator_controls_playbook
...
Look up sections of the Trial Balance Validator Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_trial_balance_validator_controls_playbook(section_anchor=<section_anchor>)
```
