...
description: Retrieve employees from Workday for the ER Case Intelligence workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve employees from Workday for the ER Case Intelligence workflow.
