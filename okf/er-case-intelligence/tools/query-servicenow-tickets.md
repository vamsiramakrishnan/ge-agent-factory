...
description: Retrieve tickets from ServiceNow for the ER Case Intelligence workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the ER Case Intelligence workflow.
