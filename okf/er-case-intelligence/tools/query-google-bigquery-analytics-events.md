...
description: Retrieve analytics events from Google BigQuery for the ER Case Intelligence workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve analytics events from Google BigQuery for the ER Case Intelligence workflow.
