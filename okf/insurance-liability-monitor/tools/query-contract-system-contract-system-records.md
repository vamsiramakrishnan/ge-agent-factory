---
type: Agent Tool
title: query_contract_system_contract_system_records
...
Retrieve contract system records from Contract System for the Insurance & Liability Monitor workflow.

- **Kind:** query
- **Source system:** [Contract System](/systems/contract-system.md)
...
No explicit permission scopes declared; source-system access is tied to [Contract System](/systems/contract-system.md).
...
```
query_contract_system_contract_system_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Contract System](/systems/contract-system.md)
