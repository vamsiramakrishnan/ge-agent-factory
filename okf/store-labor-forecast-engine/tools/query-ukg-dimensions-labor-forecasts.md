...
description: Retrieve labor forecasts from UKG Dimensions for the Store Labor Forecast Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve labor forecasts from UKG Dimensions for the Store Labor Forecast Engine workflow.
