...
description: Retrieve store shift summaries from Oracle Xstore POS for the Store Labor Forecast Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve store shift summaries from Oracle Xstore POS for the Store Labor Forecast Engine workflow.
