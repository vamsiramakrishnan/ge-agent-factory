...
description: Retrieve timecards from UKG Dimensions for the Store Labor Forecast Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve timecards from UKG Dimensions for the Store Labor Forecast Engine workflow.
