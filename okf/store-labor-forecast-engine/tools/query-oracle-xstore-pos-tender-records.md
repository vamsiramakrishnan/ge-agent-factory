...
description: Retrieve tender records from Oracle Xstore POS for the Store Labor Forecast Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve tender records from Oracle Xstore POS for the Store Labor Forecast Engine workflow.
