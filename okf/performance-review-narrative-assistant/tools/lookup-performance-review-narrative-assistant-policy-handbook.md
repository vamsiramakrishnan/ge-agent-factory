---
type: Agent Tool
title: lookup_performance_review_narrative_assistant_policy_handbook
...
Look up sections of the Performance Review Narrative Assistant Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [narrative_generation_bias_scan](/workflow/narrative-generation-bias-scan.md)
- [manager_review](/workflow/manager-review.md)
...
```
lookup_performance_review_narrative_assistant_policy_handbook(section_anchor=<section_anchor>)
```
