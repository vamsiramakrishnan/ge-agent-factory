---
type: Agent Tool
title: query_argocd_pipeline_runs
...
Retrieve pipeline runs from ArgoCD for the CI/CD Pipeline Optimizer workflow.

- **Kind:** query
- **Source system:** [ArgoCD](/systems/argocd.md)
...
No explicit permission scopes declared; source-system access is tied to [ArgoCD](/systems/argocd.md).
...
```
query_argocd_pipeline_runs(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [ArgoCD](/systems/argocd.md)
