---
type: Agent Tool
title: lookup_budget_allocator_forecaster_playbook
...
Look up sections of the Budget Allocator & Forecaster Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [roi_forecasting_simulation](/workflow/roi-forecasting-simulation.md)
...
```
lookup_budget_allocator_forecaster_playbook(section_anchor=<section_anchor>)
```
