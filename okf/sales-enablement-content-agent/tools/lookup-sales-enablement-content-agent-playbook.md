---
type: Agent Tool
title: lookup_sales_enablement_content_agent_playbook
...
Look up sections of the Sales Enablement Content Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [content_effectiveness_scoring](/workflow/content-effectiveness-scoring.md)
...
```
lookup_sales_enablement_content_agent_playbook(section_anchor=<section_anchor>)
```
