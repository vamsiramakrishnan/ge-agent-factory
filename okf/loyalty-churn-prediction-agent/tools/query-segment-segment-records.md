...
description: Retrieve segment records from Segment for the Loyalty Churn Prediction Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve segment records from Segment for the Loyalty Churn Prediction Agent workflow.
