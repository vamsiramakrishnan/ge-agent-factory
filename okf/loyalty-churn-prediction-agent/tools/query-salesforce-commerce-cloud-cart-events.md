...
description: Retrieve cart events from Salesforce Commerce Cloud for the Loyalty Churn Prediction Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cart events from Salesforce Commerce Cloud for the Loyalty Churn Prediction Agent workflow.
