...
description: Retrieve product catalog entries from Salesforce Commerce Cloud for the Loyalty Churn Prediction Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve product catalog entries from Salesforce Commerce Cloud for the Loyalty Churn Prediction Agent workflow.
