...
description: Retrieve tickets from ServiceNow for the Offboarding Orchestration workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Offboarding Orchestration workflow.
