...
description: Retrieve accounts from Google Workspace for the Offboarding Orchestration workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve accounts from Google Workspace for the Offboarding Orchestration workflow.
