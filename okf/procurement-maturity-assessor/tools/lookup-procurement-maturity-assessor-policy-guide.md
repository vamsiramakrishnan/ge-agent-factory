---
type: Agent Tool
title: lookup_procurement_maturity_assessor_policy_guide
...
Look up sections of the Procurement Maturity Assessor Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_procurement_maturity_assessor_policy_guide(section_anchor=<section_anchor>)
```
