---
type: Agent Tool
title: lookup_endpoint_security_posture_agent_runbook
...
Look up sections of the Endpoint Security Posture Agent Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_endpoint_security_posture_agent_runbook(section_anchor=<section_anchor>)
```
