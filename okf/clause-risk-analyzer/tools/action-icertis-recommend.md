---
type: Agent Tool
title: action_icertis_recommend
...
Execute the recommend step in Icertis after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Icertis](/systems/icertis.md)
- **API:** POST /api/icertis/recommend
...
```
action_icertis_recommend(target_id=<target_id>, rationale=<rationale>)
```
