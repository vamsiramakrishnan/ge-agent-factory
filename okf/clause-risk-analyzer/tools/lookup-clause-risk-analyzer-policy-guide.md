---
type: Agent Tool
title: lookup_clause_risk_analyzer_policy_guide
...
Look up sections of the Clause Risk Analyzer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [cross_clause_risk_reasoning](/workflow/cross-clause-risk-reasoning.md)
...
```
lookup_clause_risk_analyzer_policy_guide(section_anchor=<section_anchor>)
```
