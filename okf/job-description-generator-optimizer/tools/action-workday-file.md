...
Execute the file step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/file
...
```
action_workday_file(target_id=<target_id>, rationale=<rationale>)
```
