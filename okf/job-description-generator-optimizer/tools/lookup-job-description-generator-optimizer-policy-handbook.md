---
type: Agent Tool
title: lookup_job_description_generator_optimizer_policy_handbook
...
Look up sections of the Job Description Generator & Optimizer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_job_description_generator_optimizer_policy_handbook(section_anchor=<section_anchor>)
```
