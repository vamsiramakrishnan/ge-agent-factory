---
type: Eval Scenario
title: Run the Standard Cost Variance Agent workflow for the current period. Cite th...
description: "Run the Standard Cost Variance Agent workflow for the current period. Cite the relevant source-system evidence and surface any escalations required."
source_id: "standard-cost-variance-agent-end-to-end"
...
# Run the Standard Cost Variance Agent workflow for the current period. Cite the relevant source-system evidence and surface any escalations required.

## Validates

- [variance-calculation](/queries/variance-calculation.md)
