---
type: Agent Tool
title: query_e_trade_e_trade_records
...
Retrieve e trade records from E*Trade for the Equity Participant Communicator workflow.
...
```
query_e_trade_e_trade_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
