---
type: Agent Tool
title: lookup_customer_journey_mapper_playbook
...
Look up sections of the Customer Journey Mapper Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [sequential_pattern_mining](/workflow/sequential-pattern-mining.md)
...
```
lookup_customer_journey_mapper_playbook(section_anchor=<section_anchor>)
```
