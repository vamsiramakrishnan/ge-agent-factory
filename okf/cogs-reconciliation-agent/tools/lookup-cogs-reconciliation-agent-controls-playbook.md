---
type: Agent Tool
title: lookup_cogs_reconciliation_agent_controls_playbook
...
Look up sections of the COGS Reconciliation Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_cogs_reconciliation_agent_controls_playbook(section_anchor=<section_anchor>)
```
