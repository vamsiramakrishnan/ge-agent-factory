---
type: Agent Tool
title: action_sap_s_4hana_co_fi_generate
...
Execute the generate step in SAP S/4HANA CO/FI after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [SAP S/4HANA CO/FI](/systems/sap-s-4hana-co-fi.md)
- **API:** POST /api/sap_s_4hana_co_fi/generate
...
- May change SAP S/4HANA CO/FI state because the spec classifies it as action.
...
```
action_sap_s_4hana_co_fi_generate(target_id=<target_id>, rationale=<rationale>)
```
