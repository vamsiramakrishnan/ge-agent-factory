---
type: Agent Tool
title: lookup_network_dns_health_monitor_runbook
...
Look up sections of the Network & DNS Health Monitor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_network_dns_health_monitor_runbook(section_anchor=<section_anchor>)
```
