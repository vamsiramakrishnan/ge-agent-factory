---
type: Agent Tool
title: query_aws_route_53_billing_records
...
Retrieve billing records from AWS Route 53 for the Network & DNS Health Monitor workflow.
...
```
query_aws_route_53_billing_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
