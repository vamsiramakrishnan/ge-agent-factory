...
description: Retrieve analytics events from BigQuery for the Store Replenishment Orchestrator workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Store Replenishment Orchestrator workflow.
