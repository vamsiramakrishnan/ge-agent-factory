---
type: Agent Tool
title: action_oracle_retail_mfcs_approve
description: Execute the approve step in Oracle Retail MFCS after the agent has gathered evidence and validated escalation gates.
tags:
  - retail
  - okf
  - brd
...
# action_oracle_retail_mfcs_approve

Execute the approve step in Oracle Retail MFCS after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Oracle Retail MFCS](/systems/oracle-retail-mfcs.md)
- **API:** POST /api/oracle_retail_mfcs/approve
...
```
action_oracle_retail_mfcs_approve(target_id=<target_id>, rationale=<rationale>)
```
