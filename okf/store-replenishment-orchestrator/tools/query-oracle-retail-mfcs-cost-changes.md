...
description: Retrieve cost changes from Oracle Retail MFCS for the Store Replenishment Orchestrator workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cost changes from Oracle Retail MFCS for the Store Replenishment Orchestrator workflow.
