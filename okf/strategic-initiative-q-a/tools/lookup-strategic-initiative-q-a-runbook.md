---
type: Agent Tool
title: lookup_strategic_initiative_q_a_runbook
...
Look up sections of the Strategic Initiative Q&A Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_strategic_initiative_q_a_runbook(section_anchor=<section_anchor>)
```
