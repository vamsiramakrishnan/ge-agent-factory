---
type: Agent Tool
title: lookup_redline_comparison_agent_policy_guide
...
Look up sections of the Redline Comparison Agent Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_redline_comparison_agent_policy_guide(section_anchor=<section_anchor>)
```
