---
type: Agent Tool
title: lookup_pay_equity_audit_policy_handbook
...
Look up sections of the Pay Equity Audit Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [multi_variable_regression](/workflow/multi-variable-regression.md)
- [executive_reporting](/workflow/executive-reporting.md)
...
```
lookup_pay_equity_audit_policy_handbook(section_anchor=<section_anchor>)
```
