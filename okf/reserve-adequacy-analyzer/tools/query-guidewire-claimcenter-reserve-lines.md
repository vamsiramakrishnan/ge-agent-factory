...
description: Retrieve reserve lines from Guidewire ClaimCenter for the Reserve Adequacy Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve reserve lines from Guidewire ClaimCenter for the Reserve Adequacy Analyzer workflow.
