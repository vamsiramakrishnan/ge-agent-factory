...
description: Retrieve claim exposures from Guidewire ClaimCenter for the Reserve Adequacy Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve claim exposures from Guidewire ClaimCenter for the Reserve Adequacy Analyzer workflow.
