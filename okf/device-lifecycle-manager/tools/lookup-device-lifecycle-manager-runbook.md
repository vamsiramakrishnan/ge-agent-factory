---
type: Agent Tool
title: lookup_device_lifecycle_manager_runbook
...
Look up sections of the Device Lifecycle Manager Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_device_lifecycle_manager_runbook(section_anchor=<section_anchor>)
```
