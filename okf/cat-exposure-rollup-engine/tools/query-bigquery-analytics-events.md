...
description: Retrieve analytics events from BigQuery for the Catastrophe Exposure Rollup Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Catastrophe Exposure Rollup Engine workflow.
