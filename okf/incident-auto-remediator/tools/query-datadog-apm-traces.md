---
type: Agent Tool
title: query_datadog_apm_traces
...
Pull APM error traces and service dependency graphs at the time of alert to correlate failure patterns.
...
```
query_datadog_apm_traces(service_id=<service_id>, time_range=<time_range>)
```
