---
type: Agent Tool
title: query_pagerduty_active_incidents
...
Retrieve active incident details and severity to establish remediation priority and escalation path.
...
```
query_pagerduty_active_incidents(incident_id=<incident_id>)
```
