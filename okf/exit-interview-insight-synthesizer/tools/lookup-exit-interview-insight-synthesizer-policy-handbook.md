---
type: Agent Tool
title: lookup_exit_interview_insight_synthesizer_policy_handbook
...
Look up sections of the Exit Interview Insight Synthesizer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_exit_interview_insight_synthesizer_policy_handbook(section_anchor=<section_anchor>)
```
