---
type: Agent Tool
title: lookup_p2p_cycle_time_analyzer_policy_guide
...
Look up sections of the P2P Cycle Time Analyzer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_p2p_cycle_time_analyzer_policy_guide(section_anchor=<section_anchor>)
```
