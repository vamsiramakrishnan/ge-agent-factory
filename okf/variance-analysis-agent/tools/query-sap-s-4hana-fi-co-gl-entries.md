---
type: Agent Tool
title: query_sap_s_4hana_fi_co_gl_entries
...
Retrieve gl entries from SAP S/4HANA FI/CO for the Variance Analysis Agent workflow.
...
```
query_sap_s_4hana_fi_co_gl_entries(lookup_key=<lookup_key>, date_range=<date_range>)
```
