...
description: Retrieve analytics events from BigQuery for the Nonconformance Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Nonconformance Triage Agent workflow.
