...
description: Retrieve production orders from Siemens Opcenter MES for the Nonconformance Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve production orders from Siemens Opcenter MES for the Nonconformance Triage Agent workflow.
