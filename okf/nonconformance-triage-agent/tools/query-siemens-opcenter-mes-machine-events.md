...
description: Retrieve machine events from Siemens Opcenter MES for the Nonconformance Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve machine events from Siemens Opcenter MES for the Nonconformance Triage Agent workflow.
