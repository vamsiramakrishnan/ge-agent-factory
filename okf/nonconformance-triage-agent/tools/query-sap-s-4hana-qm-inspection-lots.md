...
description: Retrieve inspection lots from SAP S/4HANA QM for the Nonconformance Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve inspection lots from SAP S/4HANA QM for the Nonconformance Triage Agent workflow.
