...
description: Retrieve capa actions from SAP S/4HANA QM for the Nonconformance Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve capa actions from SAP S/4HANA QM for the Nonconformance Triage Agent workflow.
