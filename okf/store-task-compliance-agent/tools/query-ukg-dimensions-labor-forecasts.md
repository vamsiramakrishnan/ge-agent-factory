...
description: Retrieve labor forecasts from UKG Dimensions for the Store Task Compliance Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve labor forecasts from UKG Dimensions for the Store Task Compliance Agent workflow.
