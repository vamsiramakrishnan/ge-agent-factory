...
description: Retrieve timecards from UKG Dimensions for the Store Task Compliance Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve timecards from UKG Dimensions for the Store Task Compliance Agent workflow.
