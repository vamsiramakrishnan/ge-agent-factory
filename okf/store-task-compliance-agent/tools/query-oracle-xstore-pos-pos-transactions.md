...
description: Retrieve pos transactions from Oracle Xstore POS for the Store Task Compliance Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve pos transactions from Oracle Xstore POS for the Store Task Compliance Agent workflow.
