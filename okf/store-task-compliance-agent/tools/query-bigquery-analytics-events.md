...
description: Retrieve analytics events from BigQuery for the Store Task Compliance Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Store Task Compliance Agent workflow.
