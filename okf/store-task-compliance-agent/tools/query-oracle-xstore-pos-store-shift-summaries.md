...
description: Retrieve store shift summaries from Oracle Xstore POS for the Store Task Compliance Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve store shift summaries from Oracle Xstore POS for the Store Task Compliance Agent workflow.
