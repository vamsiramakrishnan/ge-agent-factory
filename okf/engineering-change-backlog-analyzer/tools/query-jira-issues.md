...
description: Retrieve issues from Jira for the Engineering Change Backlog Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve issues from Jira for the Engineering Change Backlog Analyzer workflow.
