...
description: Retrieve analytics events from BigQuery for the Engineering Change Backlog Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Engineering Change Backlog Analyzer workflow.
