---
type: Agent Tool
title: lookup_fraud_detection_engine_controls_playbook
...
Look up sections of the Fraud Detection Engine Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [statistical_detection](/workflow/statistical-detection.md)
- [case_routing](/workflow/case-routing.md)
...
```
lookup_fraud_detection_engine_controls_playbook(section_anchor=<section_anchor>)
```
