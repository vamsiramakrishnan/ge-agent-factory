...
description: Retrieve analytics events from BigQuery for the Advisory Fee Billing Anomaly Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Advisory Fee Billing Anomaly Analyzer workflow.
