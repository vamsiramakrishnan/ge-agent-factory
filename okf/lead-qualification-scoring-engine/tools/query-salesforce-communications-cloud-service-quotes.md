...
description: Retrieve service quotes from Salesforce Communications Cloud for the Lead Qualification Scoring Engine workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve service quotes from Salesforce Communications Cloud for the Lead Qualification Scoring Engine workflow.
