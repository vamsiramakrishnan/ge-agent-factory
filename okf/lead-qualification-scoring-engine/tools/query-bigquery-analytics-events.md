...
description: Retrieve analytics events from BigQuery for the Lead Qualification Scoring Engine workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Lead Qualification Scoring Engine workflow.
