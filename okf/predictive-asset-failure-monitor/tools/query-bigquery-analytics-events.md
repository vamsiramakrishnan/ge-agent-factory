...
description: Retrieve analytics events from BigQuery for the Predictive Asset Failure Monitor workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Predictive Asset Failure Monitor workflow.
