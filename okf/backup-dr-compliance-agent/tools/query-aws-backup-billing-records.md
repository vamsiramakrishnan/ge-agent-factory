---
type: Agent Tool
title: query_aws_backup_billing_records
...
Retrieve billing records from AWS Backup for the Backup & DR Compliance Agent workflow.
...
```
query_aws_backup_billing_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
