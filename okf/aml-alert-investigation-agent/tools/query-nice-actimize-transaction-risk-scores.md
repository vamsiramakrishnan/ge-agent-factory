...
description: Retrieve transaction risk scores from NICE Actimize for the AML Alert Investigation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve transaction risk scores from NICE Actimize for the AML Alert Investigation Agent workflow.
