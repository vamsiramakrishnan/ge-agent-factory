...
description: Retrieve investigation cases from NICE Actimize for the AML Alert Investigation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve investigation cases from NICE Actimize for the AML Alert Investigation Agent workflow.
