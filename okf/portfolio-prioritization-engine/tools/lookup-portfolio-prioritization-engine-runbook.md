---
type: Agent Tool
title: lookup_portfolio_prioritization_engine_runbook
...
Look up sections of the Portfolio Prioritization Engine Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_portfolio_prioritization_engine_runbook(section_anchor=<section_anchor>)
```
