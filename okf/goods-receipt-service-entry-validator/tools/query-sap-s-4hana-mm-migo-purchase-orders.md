---
type: Agent Tool
title: query_sap_s_4hana_mm_migo_purchase_orders
...
Retrieve purchase orders from SAP S/4HANA MM (MIGO) for the Goods Receipt & Service Entry Validator workflow.
...
```
query_sap_s_4hana_mm_migo_purchase_orders(lookup_key=<lookup_key>, date_range=<date_range>)
```
