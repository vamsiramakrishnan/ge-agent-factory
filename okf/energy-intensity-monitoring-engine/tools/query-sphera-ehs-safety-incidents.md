...
description: Retrieve safety incidents from Sphera EHS for the Energy Intensity Monitoring Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve safety incidents from Sphera EHS for the Energy Intensity Monitoring Engine workflow.
