---
type: Agent Tool
title: lookup_force_majeure_advisor_policy_guide
...
Look up sections of the Force Majeure Advisor Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_force_majeure_advisor_policy_guide(section_anchor=<section_anchor>)
```
