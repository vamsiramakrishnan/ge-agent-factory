...
description: Retrieve pick tasks from Manhattan Active WM for the Carrier Delivery SLA Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve pick tasks from Manhattan Active WM for the Carrier Delivery SLA Analyzer workflow.
