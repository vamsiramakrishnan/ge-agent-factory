---
type: Agent Tool
title: lookup_budget_builder_consolidation_controls_playbook
...
Look up sections of the Budget Builder & Consolidation Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_budget_builder_consolidation_controls_playbook(section_anchor=<section_anchor>)
```
