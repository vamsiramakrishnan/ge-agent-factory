---
type: Agent Tool
title: lookup_market_research_synthesizer_playbook
...
Look up sections of the Market Research Synthesizer Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [strategic_synthesis](/workflow/strategic-synthesis.md)
...
```
lookup_market_research_synthesizer_playbook(section_anchor=<section_anchor>)
```
