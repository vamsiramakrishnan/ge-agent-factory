...
description: Retrieve product catalog entries from Salesforce Commerce Cloud for the Customer Care Triage Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve product catalog entries from Salesforce Commerce Cloud for the Customer Care Triage Agent workflow.
