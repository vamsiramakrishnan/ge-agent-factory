...
description: Retrieve analytics events from BigQuery for the Customer Care Triage Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Customer Care Triage Agent workflow.
