...
description: Retrieve online orders from Salesforce Commerce Cloud for the Customer Care Triage Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve online orders from Salesforce Commerce Cloud for the Customer Care Triage Agent workflow.
