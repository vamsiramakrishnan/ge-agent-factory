...
description: "Execute the escalate step in Salesforce Commerce Cloud with a full audit trail, and escalate exceptions to the Customer Care Director."
source_id: "act-audit"
...
# Execute the escalate step in Salesforce Commerce Cloud with a full audit trail, and escalate exceptions to the Customer Care Director.
