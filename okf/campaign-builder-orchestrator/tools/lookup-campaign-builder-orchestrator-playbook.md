---
type: Agent Tool
title: lookup_campaign_builder_orchestrator_playbook
...
Look up sections of the Campaign Builder & Orchestrator Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [brief_interpretation](/workflow/brief-interpretation.md)
- [historical_performance](/workflow/historical-performance.md)
...
```
lookup_campaign_builder_orchestrator_playbook(section_anchor=<section_anchor>)
```
