...
description: Retrieve analytics events from BigQuery for the Regulatory Complaint Response Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Regulatory Complaint Response Agent workflow.
