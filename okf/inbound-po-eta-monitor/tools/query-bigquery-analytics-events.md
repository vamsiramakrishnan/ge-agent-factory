...
description: Retrieve analytics events from BigQuery for the Inbound PO ETA Monitor workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Inbound PO ETA Monitor workflow.
