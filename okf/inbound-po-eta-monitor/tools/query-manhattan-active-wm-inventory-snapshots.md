...
description: Retrieve inventory snapshots from Manhattan Active WM for the Inbound PO ETA Monitor workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve inventory snapshots from Manhattan Active WM for the Inbound PO ETA Monitor workflow.
