...
description: Retrieve analytics events from BigQuery for the Fiber Cut Triage Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Fiber Cut Triage Agent workflow.
