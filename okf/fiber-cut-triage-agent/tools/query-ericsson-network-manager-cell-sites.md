...
description: Retrieve cell sites from Ericsson Network Manager for the Fiber Cut Triage Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve cell sites from Ericsson Network Manager for the Fiber Cut Triage Agent workflow.
