...
description: Retrieve tickets from ServiceNow for the Fiber Cut Triage Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Fiber Cut Triage Agent workflow.
