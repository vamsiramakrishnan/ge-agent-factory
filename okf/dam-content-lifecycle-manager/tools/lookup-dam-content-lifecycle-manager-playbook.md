---
type: Agent Tool
title: lookup_dam_content_lifecycle_manager_playbook
...
Look up sections of the DAM & Content Lifecycle Manager Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_dam_content_lifecycle_manager_playbook(section_anchor=<section_anchor>)
```
