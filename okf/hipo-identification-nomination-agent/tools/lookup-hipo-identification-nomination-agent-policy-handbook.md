---
type: Agent Tool
title: lookup_hipo_identification_nomination_agent_policy_handbook
...
Look up sections of the HiPo Identification & Nomination Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [hi_po_scoring_bias_adjustment](/workflow/hi-po-scoring-bias-adjustment.md)
- [nomination_explainability](/workflow/nomination-explainability.md)
...
```
lookup_hipo_identification_nomination_agent_policy_handbook(section_anchor=<section_anchor>)
```
