---
type: Agent Tool
title: lookup_financial_health_assessor_policy_guide
...
Look up sections of the Financial Health Assessor Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [predictive_distress_scoring](/workflow/predictive-distress-scoring.md)
...
```
lookup_financial_health_assessor_policy_guide(section_anchor=<section_anchor>)
```
