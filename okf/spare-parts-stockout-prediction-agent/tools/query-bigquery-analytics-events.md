...
description: Retrieve analytics events from BigQuery for the Spare Parts Stockout Prediction Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Spare Parts Stockout Prediction Agent workflow.
