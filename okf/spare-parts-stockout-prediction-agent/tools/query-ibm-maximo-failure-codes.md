...
description: Retrieve failure codes from IBM Maximo for the Spare Parts Stockout Prediction Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve failure codes from IBM Maximo for the Spare Parts Stockout Prediction Agent workflow.
