...
description: Retrieve asset registry entries from IBM Maximo for the Spare Parts Stockout Prediction Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve asset registry entries from IBM Maximo for the Spare Parts Stockout Prediction Agent workflow.
