...
description: Retrieve tickets from ServiceNow for the Proactive Outage Notification Orchestrator workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Proactive Outage Notification Orchestrator workflow.
