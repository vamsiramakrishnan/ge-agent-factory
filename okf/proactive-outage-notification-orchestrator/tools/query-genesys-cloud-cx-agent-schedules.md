...
description: Retrieve agent schedules from Genesys Cloud CX for the Proactive Outage Notification Orchestrator workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve agent schedules from Genesys Cloud CX for the Proactive Outage Notification Orchestrator workflow.
