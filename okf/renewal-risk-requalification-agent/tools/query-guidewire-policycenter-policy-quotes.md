...
description: Retrieve policy quotes from Guidewire PolicyCenter for the Renewal Risk Requalification Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve policy quotes from Guidewire PolicyCenter for the Renewal Risk Requalification Agent workflow.
