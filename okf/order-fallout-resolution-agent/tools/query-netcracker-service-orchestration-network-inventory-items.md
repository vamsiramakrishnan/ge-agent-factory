...
description: Retrieve network inventory items from Netcracker Service Orchestration for the Order Fallout Resolution Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve network inventory items from Netcracker Service Orchestration for the Order Fallout Resolution Agent workflow.
