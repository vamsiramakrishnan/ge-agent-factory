...
description: Retrieve analytics events from BigQuery for the Order Fallout Resolution Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Order Fallout Resolution Agent workflow.
