...
description: Retrieve provisioning tasks from Netcracker Service Orchestration for the Order Fallout Resolution Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve provisioning tasks from Netcracker Service Orchestration for the Order Fallout Resolution Agent workflow.
