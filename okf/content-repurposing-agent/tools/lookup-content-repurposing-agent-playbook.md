---
type: Agent Tool
title: lookup_content_repurposing_agent_playbook
...
Look up sections of the Content Repurposing Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [channel_performance_analysis](/workflow/channel-performance-analysis.md)
- [intelligent_repurposing](/workflow/intelligent-repurposing.md)
...
```
lookup_content_repurposing_agent_playbook(section_anchor=<section_anchor>)
```
