---
type: Agent Tool
title: query_coursera_coursera_records
...
Retrieve coursera records from Coursera for the Learning Path Recommendation workflow.

- **Kind:** query
- **Source system:** [Coursera](/systems/coursera.md)
...
No explicit permission scopes declared; source-system access is tied to [Coursera](/systems/coursera.md).
...
```
query_coursera_coursera_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Coursera](/systems/coursera.md)
