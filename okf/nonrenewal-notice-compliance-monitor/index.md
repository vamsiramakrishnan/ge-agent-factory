...
provenance_source_ref: "apps/factory/catalog/interview-specs/nonrenewal-notice-compliance-monitor.json"
...
- **Non-renewals with defective notice**: 2.6% → 0.05%
- **Forced renewals from missed notice deadlines**: $1.9M premium annually → $0.1M premium annually
- **Regulator complaints on non-renewal handling**: 28 per year → 5 per year
