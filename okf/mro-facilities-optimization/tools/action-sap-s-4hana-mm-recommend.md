---
type: Agent Tool
title: action_sap_s_4hana_mm_recommend
...
Execute the recommend step in SAP S/4HANA MM after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [SAP S/4HANA MM](/systems/sap-s-4hana-mm.md)
- **API:** POST /api/sap_s_4hana_mm/recommend
...
```
action_sap_s_4hana_mm_recommend(target_id=<target_id>, rationale=<rationale>)
```
