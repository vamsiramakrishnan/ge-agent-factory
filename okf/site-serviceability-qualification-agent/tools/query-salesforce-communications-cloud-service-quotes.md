...
description: Retrieve service quotes from Salesforce Communications Cloud for the Site Serviceability Qualification Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve service quotes from Salesforce Communications Cloud for the Site Serviceability Qualification Agent workflow.
