...
description: Retrieve standing orders from Temenos Transact for the Dormant Account Remediation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve standing orders from Temenos Transact for the Dormant Account Remediation Agent workflow.
