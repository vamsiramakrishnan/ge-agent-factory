...
description: Retrieve tickets from ServiceNow for the Dormant Account Remediation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Dormant Account Remediation Agent workflow.
