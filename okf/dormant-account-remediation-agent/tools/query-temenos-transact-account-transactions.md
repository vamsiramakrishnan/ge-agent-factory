...
description: Retrieve account transactions from Temenos Transact for the Dormant Account Remediation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve account transactions from Temenos Transact for the Dormant Account Remediation Agent workflow.
