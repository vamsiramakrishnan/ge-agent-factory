---
type: Agent Tool
title: lookup_meeting_room_resource_optimizer_runbook
...
Look up sections of the Meeting Room & Resource Optimizer Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_meeting_room_resource_optimizer_runbook(section_anchor=<section_anchor>)
```
