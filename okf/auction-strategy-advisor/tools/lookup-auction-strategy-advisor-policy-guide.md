---
type: Agent Tool
title: lookup_auction_strategy_advisor_policy_guide
...
Look up sections of the Auction Strategy Advisor Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_auction_strategy_advisor_policy_guide(section_anchor=<section_anchor>)
```
