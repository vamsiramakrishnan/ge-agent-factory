---
type: Agent Tool
title: lookup_erg_engagement_impact_policy_handbook
...
Look up sections of the ERG Engagement & Impact Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [impact_correlation](/workflow/impact-correlation.md)
...
```
lookup_erg_engagement_impact_policy_handbook(section_anchor=<section_anchor>)
```
