---
type: Agent Tool
title: lookup_inventory_valuation_agent_controls_playbook
...
Look up sections of the Inventory Valuation Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_inventory_valuation_agent_controls_playbook(section_anchor=<section_anchor>)
```
