---
type: Agent Tool
title: lookup_data_quality_governance_agent_playbook
...
Look up sections of the Data Quality & Governance Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_data_quality_governance_agent_playbook(section_anchor=<section_anchor>)
```
