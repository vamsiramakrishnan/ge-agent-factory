...
description: Retrieve rated events from Amdocs CES Billing for the SIM Swap Fraud Detection Monitor workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve rated events from Amdocs CES Billing for the SIM Swap Fraud Detection Monitor workflow.
