...
description: Retrieve usage records from Amdocs CES Billing for the SIM Swap Fraud Detection Monitor workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve usage records from Amdocs CES Billing for the SIM Swap Fraud Detection Monitor workflow.
