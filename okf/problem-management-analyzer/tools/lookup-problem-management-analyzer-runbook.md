---
type: Agent Tool
title: lookup_problem_management_analyzer_runbook
...
Look up sections of the Problem Management Analyzer Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_problem_management_analyzer_runbook(section_anchor=<section_anchor>)
```
