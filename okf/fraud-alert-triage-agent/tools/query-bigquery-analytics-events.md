...
description: Retrieve analytics events from BigQuery for the Fraud Alert Triage Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Fraud Alert Triage Agent workflow.
