...
description: Retrieve transaction risk scores from NICE Actimize for the Fraud Alert Triage Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve transaction risk scores from NICE Actimize for the Fraud Alert Triage Agent workflow.
