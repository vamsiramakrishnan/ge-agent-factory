...
description: Retrieve tickets from ServiceNow for the Fraud Alert Triage Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Fraud Alert Triage Agent workflow.
