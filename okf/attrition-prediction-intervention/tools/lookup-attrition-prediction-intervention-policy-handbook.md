---
type: Agent Tool
title: lookup_attrition_prediction_intervention_policy_handbook
...
Look up sections of the Attrition Prediction & Intervention Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [ml_prediction](/workflow/ml-prediction.md)
- [risk_stratification](/workflow/risk-stratification.md)
- [intervention_engine](/workflow/intervention-engine.md)
...
```
lookup_attrition_prediction_intervention_policy_handbook(section_anchor=<section_anchor>)
```
