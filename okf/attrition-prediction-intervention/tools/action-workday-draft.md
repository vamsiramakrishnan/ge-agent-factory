...
Execute the draft step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/draft
...
```
action_workday_draft(target_id=<target_id>, rationale=<rationale>)
```
