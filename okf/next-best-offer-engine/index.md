...
provenance_source_ref: "apps/factory/catalog/interview-specs/next-best-offer-engine.json"
...
- **Offer redemption rate**: 3.2% → 12.5%
- **Incremental revenue per contacted member**: $1.80 → $6.40
- **Campaign audience build time**: 3 days → minutes
