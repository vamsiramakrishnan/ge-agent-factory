...
description: Retrieve store shift summaries from Oracle Xstore POS for the Next Best Offer Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve store shift summaries from Oracle Xstore POS for the Next Best Offer Engine workflow.
