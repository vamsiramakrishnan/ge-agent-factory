...
description: Retrieve tender records from Oracle Xstore POS for the Next Best Offer Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve tender records from Oracle Xstore POS for the Next Best Offer Engine workflow.
