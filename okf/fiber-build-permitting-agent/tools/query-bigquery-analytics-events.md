...
description: Retrieve analytics events from BigQuery for the Fiber Build Permitting Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Fiber Build Permitting Agent workflow.
