...
description: Retrieve tickets from ServiceNow for the Fiber Build Permitting Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Fiber Build Permitting Agent workflow.
