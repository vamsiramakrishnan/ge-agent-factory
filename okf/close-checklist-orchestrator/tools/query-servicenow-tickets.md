...
Retrieve tickets from ServiceNow for the Close Checklist Orchestrator workflow.
...
- May change ServiceNow state because the spec classifies it as query.
...
- [Confirmation policy — query_servicenow_tickets](/policies/confirmation-query-servicenow-tickets.md)
