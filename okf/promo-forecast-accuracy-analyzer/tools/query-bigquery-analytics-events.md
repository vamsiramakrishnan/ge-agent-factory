...
description: Retrieve analytics events from BigQuery for the Promo Forecast Accuracy Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Promo Forecast Accuracy Analyzer workflow.
