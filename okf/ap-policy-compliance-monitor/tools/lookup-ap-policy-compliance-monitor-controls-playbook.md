---
type: Agent Tool
title: lookup_ap_policy_compliance_monitor_controls_playbook
...
- [rule_based_compliance_trends](/workflow/rule-based-compliance-trends.md)
...
```
lookup_ap_policy_compliance_monitor_controls_playbook(section_anchor=<section_anchor>)
```
