---
type: Agent Tool
title: lookup_restructuring_impact_assessment_agent_policy_handbook
...
Look up sections of the Restructuring Impact Assessment Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_restructuring_impact_assessment_agent_policy_handbook(section_anchor=<section_anchor>)
```
