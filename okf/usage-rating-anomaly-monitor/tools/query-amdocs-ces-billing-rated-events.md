...
description: Retrieve rated events from Amdocs CES Billing for the Usage Rating Anomaly Monitor workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve rated events from Amdocs CES Billing for the Usage Rating Anomaly Monitor workflow.
