...
description: Retrieve dashboards from Looker for the Usage Rating Anomaly Monitor workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve dashboards from Looker for the Usage Rating Anomaly Monitor workflow.
