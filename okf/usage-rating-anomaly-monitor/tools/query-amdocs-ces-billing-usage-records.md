...
description: Retrieve usage records from Amdocs CES Billing for the Usage Rating Anomaly Monitor workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve usage records from Amdocs CES Billing for the Usage Rating Anomaly Monitor workflow.
