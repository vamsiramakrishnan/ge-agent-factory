...
description: Retrieve machine events from Siemens Opcenter MES for the Changeover Time Optimization Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve machine events from Siemens Opcenter MES for the Changeover Time Optimization Agent workflow.
