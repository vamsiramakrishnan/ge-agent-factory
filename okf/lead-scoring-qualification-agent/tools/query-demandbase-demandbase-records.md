---
type: Agent Tool
title: query_demandbase_demandbase_records
...
Retrieve demandbase records from Demandbase for the Lead Scoring & Qualification Agent workflow.
...
```
query_demandbase_demandbase_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
