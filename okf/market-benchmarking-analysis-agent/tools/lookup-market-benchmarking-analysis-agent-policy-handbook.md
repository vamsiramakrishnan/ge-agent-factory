---
type: Agent Tool
title: lookup_market_benchmarking_analysis_agent_policy_handbook
...
Look up sections of the Market Benchmarking Analysis Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [competitive_positioning_analysis](/workflow/competitive-positioning-analysis.md)
- [gap_detection_recommendations](/workflow/gap-detection-recommendations.md)
...
```
lookup_market_benchmarking_analysis_agent_policy_handbook(section_anchor=<section_anchor>)
```
