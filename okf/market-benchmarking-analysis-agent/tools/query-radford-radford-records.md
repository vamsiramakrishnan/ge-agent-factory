---
type: Agent Tool
title: query_radford_radford_records
...
Retrieve radford records from Radford for the Market Benchmarking Analysis Agent workflow.

- **Kind:** query
- **Source system:** [Radford](/systems/radford.md)
...
No explicit permission scopes declared; source-system access is tied to [Radford](/systems/radford.md).
...
```
query_radford_radford_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Radford](/systems/radford.md)
