---
type: Agent Tool
title: lookup_inclusive_hiring_audit_policy_handbook
...
Look up sections of the Inclusive Hiring Audit Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_inclusive_hiring_audit_policy_handbook(section_anchor=<section_anchor>)
```
