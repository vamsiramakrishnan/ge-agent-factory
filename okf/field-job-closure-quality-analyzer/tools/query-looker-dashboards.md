...
description: Retrieve dashboards from Looker for the Field Job Closure Quality Analyzer workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve dashboards from Looker for the Field Job Closure Quality Analyzer workflow.
