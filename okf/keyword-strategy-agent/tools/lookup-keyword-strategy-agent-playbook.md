---
type: Agent Tool
title: lookup_keyword_strategy_agent_playbook
...
Look up sections of the Keyword Strategy Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [intent_aware_strategy](/workflow/intent-aware-strategy.md)
- [brief_delivery](/workflow/brief-delivery.md)
...
```
lookup_keyword_strategy_agent_playbook(section_anchor=<section_anchor>)
```
