...
description: Retrieve provisioning tasks from Netcracker Service Orchestration for the Order Jeopardy Prediction Engine workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve provisioning tasks from Netcracker Service Orchestration for the Order Jeopardy Prediction Engine workflow.
