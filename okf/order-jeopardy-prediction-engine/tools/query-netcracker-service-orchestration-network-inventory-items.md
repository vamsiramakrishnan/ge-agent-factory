...
description: Retrieve network inventory items from Netcracker Service Orchestration for the Order Jeopardy Prediction Engine workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve network inventory items from Netcracker Service Orchestration for the Order Jeopardy Prediction Engine workflow.
