---
type: Agent Tool
title: lookup_api_catalog_governance_runbook
...
Look up sections of the API Catalog & Governance Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [catalog_update](/workflow/catalog-update.md)
...
```
lookup_api_catalog_governance_runbook(section_anchor=<section_anchor>)
```
