---
type: Agent Tool
title: lookup_marketing_dashboard_generator_playbook
...
Look up sections of the Marketing Dashboard Generator Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_marketing_dashboard_generator_playbook(section_anchor=<section_anchor>)
```
