...
description: Retrieve analytics events from BigQuery for the Demand Forecast Exception Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Demand Forecast Exception Agent workflow.
