...
description: Retrieve forecast overrides from Blue Yonder Demand Planning for the Demand Forecast Exception Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve forecast overrides from Blue Yonder Demand Planning for the Demand Forecast Exception Agent workflow.
