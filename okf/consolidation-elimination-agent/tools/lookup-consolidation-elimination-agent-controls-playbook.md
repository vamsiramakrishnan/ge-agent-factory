---
type: Agent Tool
title: lookup_consolidation_elimination_agent_controls_playbook
...
Look up sections of the Consolidation & Elimination Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [complex_scenario_handling](/workflow/complex-scenario-handling.md)
...
```
lookup_consolidation_elimination_agent_controls_playbook(section_anchor=<section_anchor>)
```
