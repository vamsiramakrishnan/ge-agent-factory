---
type: Agent Tool
title: lookup_duplicate_payment_detector_policy_guide
...
Look up sections of the Duplicate Payment Detector Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_duplicate_payment_detector_policy_guide(section_anchor=<section_anchor>)
```
