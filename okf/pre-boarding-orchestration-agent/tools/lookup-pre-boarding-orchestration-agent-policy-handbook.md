---
type: Agent Tool
title: lookup_pre_boarding_orchestration_agent_policy_handbook
...
Look up sections of the Pre-boarding Orchestration Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [readiness_monitoring](/workflow/readiness-monitoring.md)
...
```
lookup_pre_boarding_orchestration_agent_policy_handbook(section_anchor=<section_anchor>)
```
