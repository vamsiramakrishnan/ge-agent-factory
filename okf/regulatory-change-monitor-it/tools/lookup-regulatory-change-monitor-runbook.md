---
type: Agent Tool
title: lookup_regulatory_change_monitor_runbook
...
Look up sections of the Regulatory Change Monitor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_regulatory_change_monitor_runbook(section_anchor=<section_anchor>)
```
