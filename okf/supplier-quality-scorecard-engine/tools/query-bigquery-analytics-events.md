...
description: Retrieve analytics events from BigQuery for the Supplier Quality Scorecard Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Supplier Quality Scorecard Engine workflow.
