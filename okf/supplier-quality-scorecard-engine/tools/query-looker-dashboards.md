...
description: Retrieve dashboards from Looker for the Supplier Quality Scorecard Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve dashboards from Looker for the Supplier Quality Scorecard Engine workflow.
