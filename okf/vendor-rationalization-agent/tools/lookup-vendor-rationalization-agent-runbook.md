---
type: Agent Tool
title: lookup_vendor_rationalization_agent_runbook
...
Look up sections of the Vendor Rationalization Agent Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_vendor_rationalization_agent_runbook(section_anchor=<section_anchor>)
```
