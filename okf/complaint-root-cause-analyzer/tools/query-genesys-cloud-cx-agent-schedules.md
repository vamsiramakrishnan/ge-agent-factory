...
description: Retrieve agent schedules from Genesys Cloud CX for the Complaint Root Cause Analyzer workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve agent schedules from Genesys Cloud CX for the Complaint Root Cause Analyzer workflow.
