...
description: Retrieve tickets from ServiceNow for the Loan Documentation Exception Clearing Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Loan Documentation Exception Clearing Agent workflow.
