...
description: Retrieve credit memos from nCino Loan Origination for the Loan Documentation Exception Clearing Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve credit memos from nCino Loan Origination for the Loan Documentation Exception Clearing Agent workflow.
