---
type: Agent Tool
title: lookup_supplier_scorecard_generator_policy_guide
...
Look up sections of the Supplier Scorecard Generator Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_supplier_scorecard_generator_policy_guide(section_anchor=<section_anchor>)
```
