---
type: Agent Tool
title: lookup_tail_spend_classifier_opportunity_finder_policy_guide
...
Look up sections of the Tail Spend Classifier & Opportunity Finder Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_tail_spend_classifier_opportunity_finder_policy_guide(section_anchor=<section_anchor>)
```
