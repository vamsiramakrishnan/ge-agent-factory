---
type: Agent Tool
title: lookup_sales_use_tax_automation_controls_playbook
...
Look up sections of the Sales & Use Tax Automation Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_sales_use_tax_automation_controls_playbook(section_anchor=<section_anchor>)
```
