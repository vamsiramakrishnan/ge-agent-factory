---
type: Agent Tool
title: query_coupa_analytics_requisitions
...
Retrieve requisitions from Coupa Analytics for the Category Spend Dashboard workflow.
...
```
query_coupa_analytics_requisitions(lookup_key=<lookup_key>, date_range=<date_range>)
```
