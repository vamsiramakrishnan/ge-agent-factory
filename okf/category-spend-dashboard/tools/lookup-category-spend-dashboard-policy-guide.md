---
type: Agent Tool
title: lookup_category_spend_dashboard_policy_guide
...
Look up sections of the Category Spend Dashboard Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [anomaly_detection_trending](/workflow/anomaly-detection-trending.md)
...
```
lookup_category_spend_dashboard_policy_guide(section_anchor=<section_anchor>)
```
