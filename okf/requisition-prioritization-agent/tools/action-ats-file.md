...
Execute the file step in ATS after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [ATS](/systems/ats.md)
- **API:** POST /api/ats/file
...
```
action_ats_file(target_id=<target_id>, rationale=<rationale>)
```
