---
type: Agent Tool
title: lookup_requisition_prioritization_agent_policy_handbook
...
Look up sections of the Requisition Prioritization Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [recruiter_matching](/workflow/recruiter-matching.md)
...
```
lookup_requisition_prioritization_agent_policy_handbook(section_anchor=<section_anchor>)
```
