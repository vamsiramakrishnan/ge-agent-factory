---
type: Agent Tool
title: action_google_docs_draft
...
Execute the draft step in Google Docs after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Google Docs](/systems/google-docs.md)
- **API:** POST /api/google_docs/draft
...
```
action_google_docs_draft(target_id=<target_id>, rationale=<rationale>)
```
