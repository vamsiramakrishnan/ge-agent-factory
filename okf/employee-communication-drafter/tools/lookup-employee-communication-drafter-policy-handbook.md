---
type: Agent Tool
title: lookup_employee_communication_drafter_policy_handbook
...
Look up sections of the Employee Communication Drafter Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_employee_communication_drafter_policy_handbook(section_anchor=<section_anchor>)
```
