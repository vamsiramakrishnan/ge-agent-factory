---
type: Agent Tool
title: lookup_communication_reach_sentiment_analyzer_policy_handbook
...
Look up sections of the Communication Reach & Sentiment Analyzer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [sentiment_analysis](/workflow/sentiment-analysis.md)
...
```
lookup_communication_reach_sentiment_analyzer_policy_handbook(section_anchor=<section_anchor>)
```
