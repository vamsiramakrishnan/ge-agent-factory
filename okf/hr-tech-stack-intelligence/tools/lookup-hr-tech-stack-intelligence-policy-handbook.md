---
type: Agent Tool
title: lookup_hr_tech_stack_intelligence_policy_handbook
...
Look up sections of the HR Tech Stack Intelligence Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [renewal_intelligence](/workflow/renewal-intelligence.md)
...
```
lookup_hr_tech_stack_intelligence_policy_handbook(section_anchor=<section_anchor>)
```
