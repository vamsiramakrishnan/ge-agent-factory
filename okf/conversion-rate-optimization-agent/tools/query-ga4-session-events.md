...
Retrieve session events from GA4 for the Conversion Rate Optimization Agent workflow.
...
- [statistical_funnel_analysis](/workflow/statistical-funnel-analysis.md)
