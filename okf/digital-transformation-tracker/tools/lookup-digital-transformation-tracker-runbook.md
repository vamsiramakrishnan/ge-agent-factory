---
type: Agent Tool
title: lookup_digital_transformation_tracker_runbook
...
Look up sections of the Digital Transformation Tracker Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_digital_transformation_tracker_runbook(section_anchor=<section_anchor>)
```
