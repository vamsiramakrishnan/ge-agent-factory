...
description: Retrieve machine events from Siemens Opcenter MES for the OEE Loss Pareto Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve machine events from Siemens Opcenter MES for the OEE Loss Pareto Analyzer workflow.
