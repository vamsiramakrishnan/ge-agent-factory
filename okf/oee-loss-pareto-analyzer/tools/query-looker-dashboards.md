...
description: Retrieve dashboards from Looker for the OEE Loss Pareto Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve dashboards from Looker for the OEE Loss Pareto Analyzer workflow.
