---
type: Agent Tool
title: lookup_workforce_cost_modeling_policy_handbook
...
Look up sections of the Workforce Cost Modeling Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [fully_loaded_modeling](/workflow/fully-loaded-modeling.md)
...
```
lookup_workforce_cost_modeling_policy_handbook(section_anchor=<section_anchor>)
```
