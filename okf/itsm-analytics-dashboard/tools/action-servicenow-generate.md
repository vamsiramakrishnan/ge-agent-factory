---
type: Agent Tool
title: action_servicenow_generate
...
Execute the generate step in ServiceNow after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [ServiceNow](/systems/servicenow.md)
- **API:** POST /api/servicenow/generate
...
```
action_servicenow_generate(target_id=<target_id>, rationale=<rationale>)
```
