---
type: Agent Tool
title: lookup_gl_anomaly_detector_controls_playbook
...
Look up sections of the GL Anomaly Detector Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_gl_anomaly_detector_controls_playbook(section_anchor=<section_anchor>)
```
