...
description: Retrieve analytics events from BigQuery for the CAPA Orchestration Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the CAPA Orchestration Agent workflow.
