...
description: Retrieve nonconformance records from SAP S/4HANA QM for the CAPA Orchestration Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve nonconformance records from SAP S/4HANA QM for the CAPA Orchestration Agent workflow.
