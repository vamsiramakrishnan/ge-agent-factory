...
description: Retrieve capa actions from SAP S/4HANA QM for the CAPA Orchestration Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve capa actions from SAP S/4HANA QM for the CAPA Orchestration Agent workflow.
