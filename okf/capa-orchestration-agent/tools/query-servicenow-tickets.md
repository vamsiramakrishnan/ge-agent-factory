...
description: Retrieve tickets from ServiceNow for the CAPA Orchestration Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the CAPA Orchestration Agent workflow.
