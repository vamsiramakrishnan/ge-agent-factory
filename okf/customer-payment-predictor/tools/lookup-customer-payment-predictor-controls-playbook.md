---
type: Agent Tool
title: lookup_customer_payment_predictor_controls_playbook
...
Look up sections of the Customer Payment Predictor Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_customer_payment_predictor_controls_playbook(section_anchor=<section_anchor>)
```
