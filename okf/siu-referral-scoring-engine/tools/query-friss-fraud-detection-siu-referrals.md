...
description: Retrieve siu referrals from FRISS Fraud Detection for the SIU Referral Scoring Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve siu referrals from FRISS Fraud Detection for the SIU Referral Scoring Engine workflow.
