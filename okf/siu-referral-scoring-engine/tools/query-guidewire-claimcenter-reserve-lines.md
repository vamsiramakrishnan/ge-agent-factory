...
description: Retrieve reserve lines from Guidewire ClaimCenter for the SIU Referral Scoring Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve reserve lines from Guidewire ClaimCenter for the SIU Referral Scoring Engine workflow.
