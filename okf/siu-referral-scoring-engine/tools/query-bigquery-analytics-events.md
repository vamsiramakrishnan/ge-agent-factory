...
description: Retrieve analytics events from BigQuery for the SIU Referral Scoring Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the SIU Referral Scoring Engine workflow.
