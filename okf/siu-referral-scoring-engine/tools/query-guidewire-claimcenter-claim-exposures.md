...
description: Retrieve claim exposures from Guidewire ClaimCenter for the SIU Referral Scoring Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve claim exposures from Guidewire ClaimCenter for the SIU Referral Scoring Engine workflow.
