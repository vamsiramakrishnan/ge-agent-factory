...
description: "Payment data, vendor master, withholding tax postings, certificate generation"
tags:
  - finance
  - okf
  - brd
...
Payment data, vendor master, withholding tax postings, certificate generation
