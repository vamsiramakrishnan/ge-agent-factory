---
type: Agent Tool
title: lookup_hipo_development_journey_agent_policy_handbook
...
Look up sections of the HiPo Development Journey Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_hipo_development_journey_agent_policy_handbook(section_anchor=<section_anchor>)
```
