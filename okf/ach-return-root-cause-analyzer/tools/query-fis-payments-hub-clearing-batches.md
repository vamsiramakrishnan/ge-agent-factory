...
description: Retrieve clearing batches from FIS Payments Hub for the ACH Return Root Cause Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve clearing batches from FIS Payments Hub for the ACH Return Root Cause Analyzer workflow.
