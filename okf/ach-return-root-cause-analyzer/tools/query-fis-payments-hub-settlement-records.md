...
description: Retrieve settlement records from FIS Payments Hub for the ACH Return Root Cause Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve settlement records from FIS Payments Hub for the ACH Return Root Cause Analyzer workflow.
