...
description: Operating contract for the Content Brief Generator agent.
tags:
  - marketing
  - okf
  - brd
...
| --- | --- | --- |
| Brief creation time regresses past the 4-6 hours baseline by more than 20% | escalate_to_human | Significant regressions need human judgment before automated remediation runs against production records. |
