...
description: Retrieve screening results from Fenergo CLM for the Periodic KYC Review Orchestrator workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve screening results from Fenergo CLM for the Periodic KYC Review Orchestrator workflow.
