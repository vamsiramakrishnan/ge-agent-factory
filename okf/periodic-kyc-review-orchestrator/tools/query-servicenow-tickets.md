...
description: Retrieve tickets from ServiceNow for the Periodic KYC Review Orchestrator workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Periodic KYC Review Orchestrator workflow.
