...
description: Retrieve entity profiles from Fenergo CLM for the Periodic KYC Review Orchestrator workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve entity profiles from Fenergo CLM for the Periodic KYC Review Orchestrator workflow.
