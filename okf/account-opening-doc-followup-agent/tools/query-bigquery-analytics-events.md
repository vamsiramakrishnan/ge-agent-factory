...
description: "Retrieve analytics events from BigQuery for the Account Opening Document Follow-Up Agent workflow."
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Account Opening Document Follow-Up Agent workflow.
