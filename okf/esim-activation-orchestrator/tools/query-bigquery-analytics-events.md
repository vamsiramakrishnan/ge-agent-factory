...
description: Retrieve analytics events from BigQuery for the eSIM Activation Orchestrator workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the eSIM Activation Orchestrator workflow.
