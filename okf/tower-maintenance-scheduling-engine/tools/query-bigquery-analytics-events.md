...
description: Retrieve analytics events from BigQuery for the Tower Maintenance Scheduling Engine workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Tower Maintenance Scheduling Engine workflow.
