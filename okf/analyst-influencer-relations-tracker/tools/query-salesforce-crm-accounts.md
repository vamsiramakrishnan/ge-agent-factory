---
type: Agent Tool
title: query_salesforce_crm_accounts
...
Retrieve accounts from Salesforce CRM for the Analyst & Influencer Relations Tracker workflow.
...
```
query_salesforce_crm_accounts(lookup_key=<lookup_key>, date_range=<date_range>)
```
