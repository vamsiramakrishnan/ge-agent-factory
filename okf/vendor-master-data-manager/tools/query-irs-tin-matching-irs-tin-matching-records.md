---
type: Agent Tool
title: query_irs_tin_matching_irs_tin_matching_records
...
Retrieve irs tin matching records from IRS TIN Matching for the Vendor Master Data Manager workflow.

- **Kind:** query
- **Source system:** [IRS TIN Matching](/systems/irs-tin-matching.md)
...
No explicit permission scopes declared; source-system access is tied to [IRS TIN Matching](/systems/irs-tin-matching.md).
...
```
query_irs_tin_matching_irs_tin_matching_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [IRS TIN Matching](/systems/irs-tin-matching.md)
