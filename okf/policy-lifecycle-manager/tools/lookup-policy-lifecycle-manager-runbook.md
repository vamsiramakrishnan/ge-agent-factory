---
type: Agent Tool
title: lookup_policy_lifecycle_manager_runbook
...
Look up sections of the Policy Lifecycle Manager Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_policy_lifecycle_manager_runbook(section_anchor=<section_anchor>)
```
