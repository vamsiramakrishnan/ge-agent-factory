---
type: Agent Tool
title: lookup_price_variance_analyzer_policy_guide
...
Look up sections of the Price Variance Analyzer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [statistical_variance_detection](/workflow/statistical-variance-detection.md)
...
```
lookup_price_variance_analyzer_policy_guide(section_anchor=<section_anchor>)
```
