...
description: Retrieve positions from Murex MX.3 for the VaR Limit Breach Triage Monitor workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve positions from Murex MX.3 for the VaR Limit Breach Triage Monitor workflow.
