---
type: Agent Tool
title: lookup_workspace_analytics_agent_runbook
...
Look up sections of the Workspace Analytics Agent Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_workspace_analytics_agent_runbook(section_anchor=<section_anchor>)
```
