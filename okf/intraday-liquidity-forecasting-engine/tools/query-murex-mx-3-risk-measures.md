...
description: Retrieve risk measures from Murex MX.3 for the Intraday Liquidity Forecasting Engine workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve risk measures from Murex MX.3 for the Intraday Liquidity Forecasting Engine workflow.
