...
description: Retrieve analytics events from BigQuery for the Submission Appetite Screening Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Submission Appetite Screening Agent workflow.
