---
type: Agent Tool
title: lookup_duplicate_invoice_detector_controls_playbook
...
Look up sections of the Duplicate Invoice Detector Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_duplicate_invoice_detector_controls_playbook(section_anchor=<section_anchor>)
```
