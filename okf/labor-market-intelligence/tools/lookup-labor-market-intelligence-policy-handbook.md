---
type: Agent Tool
title: lookup_labor_market_intelligence_policy_handbook
...
Look up sections of the Labor Market Intelligence Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_labor_market_intelligence_policy_handbook(section_anchor=<section_anchor>)
```
