...
description: Retrieve purchase orders from SAP S/4HANA MM for the Supplier Delivery Risk Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve purchase orders from SAP S/4HANA MM for the Supplier Delivery Risk Analyzer workflow.
