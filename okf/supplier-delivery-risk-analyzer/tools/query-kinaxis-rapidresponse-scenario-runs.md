...
description: Retrieve scenario runs from Kinaxis RapidResponse for the Supplier Delivery Risk Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve scenario runs from Kinaxis RapidResponse for the Supplier Delivery Risk Analyzer workflow.
