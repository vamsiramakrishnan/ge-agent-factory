---
type: Agent Tool
title: action_sap_s_4hana_mm_publish
description: Execute the publish step in SAP S/4HANA MM after the agent has gathered evidence and validated escalation gates.
tags:
  - manufacturing
  - okf
  - brd
...
# action_sap_s_4hana_mm_publish

Execute the publish step in SAP S/4HANA MM after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [SAP S/4HANA MM](/systems/sap-s-4hana-mm.md)
- **API:** POST /api/sap_s_4hana_mm/publish
...
```
action_sap_s_4hana_mm_publish(target_id=<target_id>, rationale=<rationale>)
```
