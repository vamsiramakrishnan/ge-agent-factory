...
description: Retrieve analytics events from BigQuery for the Supplier Delivery Risk Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Supplier Delivery Risk Analyzer workflow.
