...
description: Retrieve product catalog entries from Salesforce Commerce Cloud for the Returns Abuse Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve product catalog entries from Salesforce Commerce Cloud for the Returns Abuse Analyzer workflow.
