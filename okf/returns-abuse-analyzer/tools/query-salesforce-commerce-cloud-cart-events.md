...
description: Retrieve cart events from Salesforce Commerce Cloud for the Returns Abuse Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cart events from Salesforce Commerce Cloud for the Returns Abuse Analyzer workflow.
