---
type: Agent Tool
title: lookup_returns_abuse_analyzer_execution_playbook
description: "Look up sections of the Returns Abuse Analyzer Retail Execution Playbook to cite in narrative output, escalation rationale, and audit evidence."
tags:
  - retail
  - okf
  - brd
...
# lookup_returns_abuse_analyzer_execution_playbook

Look up sections of the Returns Abuse Analyzer Retail Execution Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_returns_abuse_analyzer_execution_playbook(section_anchor=<section_anchor>)
```
