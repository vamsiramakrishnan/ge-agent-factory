...
title: "Cross-check every finding against the Returns Abuse Analyzer Retail Execution..."
description: "Cross-check every finding against the Returns Abuse Analyzer Retail Execution Playbook and cite the governing sections before any recommendation is issued."
...
# Cross-check every finding against the Returns Abuse Analyzer Retail Execution Playbook and cite the governing sections before any recommendation is issued.
