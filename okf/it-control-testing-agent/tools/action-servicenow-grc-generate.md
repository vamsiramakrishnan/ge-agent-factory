---
type: Agent Tool
title: action_servicenow_grc_generate
...
Execute the generate step in ServiceNow GRC after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [ServiceNow GRC](/systems/servicenow-grc.md)
- **API:** POST /api/servicenow_grc/generate
...
- May change ServiceNow GRC state because the spec classifies it as action.
...
```
action_servicenow_grc_generate(target_id=<target_id>, rationale=<rationale>)
```
