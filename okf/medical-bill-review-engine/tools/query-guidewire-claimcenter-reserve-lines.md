...
description: Retrieve reserve lines from Guidewire ClaimCenter for the Medical Bill Review Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve reserve lines from Guidewire ClaimCenter for the Medical Bill Review Engine workflow.
