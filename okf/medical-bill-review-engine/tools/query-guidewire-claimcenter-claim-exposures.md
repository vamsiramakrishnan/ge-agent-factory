...
description: Retrieve claim exposures from Guidewire ClaimCenter for the Medical Bill Review Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve claim exposures from Guidewire ClaimCenter for the Medical Bill Review Engine workflow.
