---
type: Agent Tool
title: lookup_merit_promotion_budget_modeler_agent_policy_handbook
...
Look up sections of the Merit & Promotion Budget Modeler Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [multi_scenario_modeling](/workflow/multi-scenario-modeling.md)
...
```
lookup_merit_promotion_budget_modeler_agent_policy_handbook(section_anchor=<section_anchor>)
```
