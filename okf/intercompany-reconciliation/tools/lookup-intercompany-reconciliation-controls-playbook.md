---
type: Agent Tool
title: lookup_intercompany_reconciliation_controls_playbook
...
Look up sections of the Intercompany Reconciliation Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_intercompany_reconciliation_controls_playbook(section_anchor=<section_anchor>)
```
