...
title: Call lookup_incident_near_miss_triage_agent_sop to cite the governing SOP sec...
description: "Call lookup_incident_near_miss_triage_agent_sop to cite the governing SOP sections and cross-check the 29 CFR 1904 Recordkeeping and Reporting Compliance Bulletin before any classification or escalation is finalized."
source_id: "sop-recordkeeping-bulletin-evidence-gate"
...
# Call lookup_incident_near_miss_triage_agent_sop to cite the governing SOP sections and cross-check the 29 CFR 1904 Recordkeeping and Reporting Compliance Bulletin before any classification or escalation is finalized.
