...
description: Retrieve purchase orders from SAP S/4HANA MM for the Expedite Request Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve purchase orders from SAP S/4HANA MM for the Expedite Request Triage Agent workflow.
