---
type: Agent Tool
title: lookup_expedite_request_triage_agent_sop
description: "Look up sections of the Expedite Request Triage Agent Standard Operating Procedure to cite in narrative output, escalation rationale, and audit evidence."
tags:
  - manufacturing
  - okf
  - brd
...
# lookup_expedite_request_triage_agent_sop

Look up sections of the Expedite Request Triage Agent Standard Operating Procedure to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_expedite_request_triage_agent_sop(section_anchor=<section_anchor>)
```
