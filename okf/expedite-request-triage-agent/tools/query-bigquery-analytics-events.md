...
description: Retrieve analytics events from BigQuery for the Expedite Request Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Expedite Request Triage Agent workflow.
