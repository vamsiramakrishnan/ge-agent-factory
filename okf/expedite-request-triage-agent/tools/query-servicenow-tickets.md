...
description: Retrieve tickets from ServiceNow for the Expedite Request Triage Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Expedite Request Triage Agent workflow.
