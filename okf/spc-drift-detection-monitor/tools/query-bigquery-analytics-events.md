...
description: Retrieve analytics events from BigQuery for the SPC Drift Detection Monitor workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the SPC Drift Detection Monitor workflow.
