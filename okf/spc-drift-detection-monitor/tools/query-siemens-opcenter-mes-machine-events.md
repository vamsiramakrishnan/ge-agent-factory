...
description: Retrieve machine events from Siemens Opcenter MES for the SPC Drift Detection Monitor workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve machine events from Siemens Opcenter MES for the SPC Drift Detection Monitor workflow.
