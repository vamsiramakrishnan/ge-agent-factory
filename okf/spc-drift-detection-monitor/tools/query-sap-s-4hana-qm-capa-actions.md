...
description: Retrieve capa actions from SAP S/4HANA QM for the SPC Drift Detection Monitor workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve capa actions from SAP S/4HANA QM for the SPC Drift Detection Monitor workflow.
