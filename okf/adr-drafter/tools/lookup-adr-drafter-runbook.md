---
type: Agent Tool
title: lookup_adr_drafter_runbook
...
Look up sections of the ADR Drafter Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_adr_drafter_runbook(section_anchor=<section_anchor>)
```
