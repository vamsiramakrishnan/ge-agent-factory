---
type: Agent Tool
title: lookup_marketing_plan_generator_playbook
...
Look up sections of the Marketing Plan Generator Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [channel_mix_optimization](/workflow/channel-mix-optimization.md)
- [plan_narrative_generation](/workflow/plan-narrative-generation.md)
...
```
lookup_marketing_plan_generator_playbook(section_anchor=<section_anchor>)
```
