...
description: Retrieve analytics events from BigQuery for the Assortment Rationalization Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Assortment Rationalization Engine workflow.
