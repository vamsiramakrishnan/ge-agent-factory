...
title: Query item master and merchandise hierarchy from Oracle Retail MFCS for the A...
description: Query item master and merchandise hierarchy from Oracle Retail MFCS for the Assortment Rationalization Engine workflow.
...
# Query item master and merchandise hierarchy from Oracle Retail MFCS for the Assortment Rationalization Engine workflow.
