---
type: Agent Tool
title: lookup_small_commercial_quote_bind_stp_engine_authority_guide
description: "Look up sections of the Small Commercial Quote-Bind STP Engine Authority & Referral Guide to cite in narrative output, escalation rationale, and audit evidence."
tags:
  - insurance
  - okf
  - brd
...
# lookup_small_commercial_quote_bind_stp_engine_authority_guide

Look up sections of the Small Commercial Quote-Bind STP Engine Authority & Referral Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_small_commercial_quote_bind_stp_engine_authority_guide(section_anchor=<section_anchor>)
```
