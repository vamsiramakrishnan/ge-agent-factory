---
type: Agent Tool
title: lookup_leave_accommodation_intake_agent_policy_handbook
...
Look up sections of the Leave & Accommodation Intake Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_leave_accommodation_intake_agent_policy_handbook(section_anchor=<section_anchor>)
```
