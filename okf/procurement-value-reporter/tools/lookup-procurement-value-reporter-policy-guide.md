---
type: Agent Tool
title: lookup_procurement_value_reporter_policy_guide
...
Look up sections of the Procurement Value Reporter Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [impact_modeling](/workflow/impact-modeling.md)
...
```
lookup_procurement_value_reporter_policy_guide(section_anchor=<section_anchor>)
```
