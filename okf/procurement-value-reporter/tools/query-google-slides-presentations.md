...
Retrieve presentations from Google Slides for the Procurement Value Reporter workflow.
...
- [narrative_presentation_generation](/workflow/narrative-presentation-generation.md)
