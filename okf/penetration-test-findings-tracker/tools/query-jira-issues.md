...
description: Retrieve issues from Jira for the Penetration Test Findings Tracker workflow.
tags:
  - it
  - okf
  - brd
...
Retrieve issues from Jira for the Penetration Test Findings Tracker workflow.
