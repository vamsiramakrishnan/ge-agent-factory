...
description: Retrieve analytics events from BigQuery for the Penetration Test Findings Tracker workflow.
tags:
  - it
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Penetration Test Findings Tracker workflow.
