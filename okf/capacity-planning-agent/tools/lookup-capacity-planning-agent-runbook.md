---
type: Agent Tool
title: lookup_capacity_planning_agent_runbook
...
Look up sections of the Capacity Planning Agent Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [growth_forecasting](/workflow/growth-forecasting.md)
- [business_event_correlation](/workflow/business-event-correlation.md)
- [action_budget](/workflow/action-budget.md)
...
```
lookup_capacity_planning_agent_runbook(section_anchor=<section_anchor>)
```
