...
title: "Cross-check every finding against the Markdown Optimization Engine Retail Exe..."
description: "Cross-check every finding against the Markdown Optimization Engine Retail Execution Playbook and cite the governing sections before any recommendation is issued."
...
# Cross-check every finding against the Markdown Optimization Engine Retail Execution Playbook and cite the governing sections before any recommendation is issued.
