...
description: Retrieve cost changes from Oracle Retail MFCS for the Markdown Optimization Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cost changes from Oracle Retail MFCS for the Markdown Optimization Engine workflow.
