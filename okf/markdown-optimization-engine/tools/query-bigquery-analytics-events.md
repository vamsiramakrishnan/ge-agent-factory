...
description: Retrieve analytics events from BigQuery for the Markdown Optimization Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Markdown Optimization Engine workflow.
