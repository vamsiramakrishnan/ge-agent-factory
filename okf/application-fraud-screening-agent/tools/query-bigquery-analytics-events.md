...
description: Retrieve analytics events from BigQuery for the Application Fraud Screening Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Application Fraud Screening Agent workflow.
