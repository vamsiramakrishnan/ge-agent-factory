...
description: Retrieve network link indicators from FRISS Fraud Detection for the Application Fraud Screening Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve network link indicators from FRISS Fraud Detection for the Application Fraud Screening Agent workflow.
