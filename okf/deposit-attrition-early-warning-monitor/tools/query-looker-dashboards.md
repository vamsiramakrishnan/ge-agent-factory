...
description: Retrieve dashboards from Looker for the Deposit Attrition Early Warning Monitor workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve dashboards from Looker for the Deposit Attrition Early Warning Monitor workflow.
