...
description: Retrieve analytics events from BigQuery for the Savings Pipeline Tracker workflow.
tags:
  - procurement
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Savings Pipeline Tracker workflow.
