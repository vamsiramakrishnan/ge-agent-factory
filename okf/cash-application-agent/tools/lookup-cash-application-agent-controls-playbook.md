---
type: Agent Tool
title: lookup_cash_application_agent_controls_playbook
...
Look up sections of the Cash Application Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_cash_application_agent_controls_playbook(section_anchor=<section_anchor>)
```
