---
type: Agent Tool
title: lookup_brand_voice_checker_playbook
...
Look up sections of the Brand Voice Checker Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [feedback_delivery](/workflow/feedback-delivery.md)
...
```
lookup_brand_voice_checker_playbook(section_anchor=<section_anchor>)
```
