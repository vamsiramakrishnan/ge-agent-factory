---
type: Agent Tool
title: lookup_technology_radar_trend_scout_runbook
...
Look up sections of the Technology Radar & Trend Scout Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [adoption_curve_modeling](/workflow/adoption-curve-modeling.md)
...
```
lookup_technology_radar_trend_scout_runbook(section_anchor=<section_anchor>)
```
