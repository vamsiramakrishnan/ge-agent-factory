---
type: Agent Tool
title: lookup_new_hire_q_a_assistant_policy_handbook
...
Look up sections of the New Hire Q&A Assistant Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_new_hire_q_a_assistant_policy_handbook(section_anchor=<section_anchor>)
```
