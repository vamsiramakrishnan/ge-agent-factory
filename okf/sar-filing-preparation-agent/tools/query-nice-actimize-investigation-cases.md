...
description: Retrieve investigation cases from NICE Actimize for the SAR Filing Preparation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve investigation cases from NICE Actimize for the SAR Filing Preparation Agent workflow.
