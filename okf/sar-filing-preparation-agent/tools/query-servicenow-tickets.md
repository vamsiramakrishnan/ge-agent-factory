...
description: Retrieve tickets from ServiceNow for the SAR Filing Preparation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the SAR Filing Preparation Agent workflow.
