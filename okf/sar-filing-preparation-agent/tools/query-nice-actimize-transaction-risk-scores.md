...
description: Retrieve transaction risk scores from NICE Actimize for the SAR Filing Preparation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve transaction risk scores from NICE Actimize for the SAR Filing Preparation Agent workflow.
