---
type: Agent Tool
title: lookup_abm_campaign_manager_playbook
...
Look up sections of the ABM Campaign Manager Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_abm_campaign_manager_playbook(section_anchor=<section_anchor>)
```
