---
type: Agent Tool
title: lookup_supplier_risk_scoring_engine_policy_guide
...
Look up sections of the Supplier Risk Scoring Engine Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [multi_factor_risk_scoring](/workflow/multi-factor-risk-scoring.md)
- [alert_dashboard_delivery](/workflow/alert-dashboard-delivery.md)
...
```
lookup_supplier_risk_scoring_engine_policy_guide(section_anchor=<section_anchor>)
```
