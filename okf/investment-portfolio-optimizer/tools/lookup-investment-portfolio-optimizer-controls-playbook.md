---
type: Agent Tool
title: lookup_investment_portfolio_optimizer_controls_playbook
...
Look up sections of the Investment Portfolio Optimizer Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_investment_portfolio_optimizer_controls_playbook(section_anchor=<section_anchor>)
```
