...
description: Retrieve analytics events from BigQuery for the Shrink Anomaly Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Shrink Anomaly Analyzer workflow.
