...
description: Retrieve dashboards from Looker for the Shrink Anomaly Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve dashboards from Looker for the Shrink Anomaly Analyzer workflow.
