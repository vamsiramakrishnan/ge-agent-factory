...
description: Retrieve tender records from Oracle Xstore POS for the Shrink Anomaly Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve tender records from Oracle Xstore POS for the Shrink Anomaly Analyzer workflow.
