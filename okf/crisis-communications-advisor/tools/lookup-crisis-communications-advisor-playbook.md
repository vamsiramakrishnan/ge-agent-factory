---
type: Agent Tool
title: lookup_crisis_communications_advisor_playbook
...
Look up sections of the Crisis Communications Advisor Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [severity_scoring](/workflow/severity-scoring.md)
...
```
lookup_crisis_communications_advisor_playbook(section_anchor=<section_anchor>)
```
