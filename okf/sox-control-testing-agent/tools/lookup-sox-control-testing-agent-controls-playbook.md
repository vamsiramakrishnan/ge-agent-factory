---
type: Agent Tool
title: lookup_sox_control_testing_agent_controls_playbook
...
Look up sections of the SOX Control Testing Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [statistical_sampling_testing](/workflow/statistical-sampling-testing.md)
...
```
lookup_sox_control_testing_agent_controls_playbook(section_anchor=<section_anchor>)
```
