---
type: Agent Tool
title: lookup_management_reporting_agent_controls_playbook
...
Look up sections of the Management Reporting Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_management_reporting_agent_controls_playbook(section_anchor=<section_anchor>)
```
