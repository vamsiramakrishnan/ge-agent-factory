---
type: Agent Tool
title: lookup_kpi_dashboard_builder_controls_playbook
...
Look up sections of the KPI Dashboard Builder Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_kpi_dashboard_builder_controls_playbook(section_anchor=<section_anchor>)
```
