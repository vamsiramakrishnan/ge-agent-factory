---
type: Agent Tool
title: query_sap_s_4hana_fi_payroll_exceptions
description: "Retrieve active pre-payroll exceptions mapped in the database for benefits discrepancies."
tags:
  - hr
  - okf
  - brd
...
# query_sap_s_4hana_fi_payroll_exceptions

Retrieve active pre-payroll exceptions mapped in the database for benefits discrepancies.
...
```
query_sap_s_4hana_fi_payroll_exceptions(employee_id=<employee_id>)
```
