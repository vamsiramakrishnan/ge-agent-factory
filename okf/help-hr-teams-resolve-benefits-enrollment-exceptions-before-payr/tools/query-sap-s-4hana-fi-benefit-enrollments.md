---
type: Agent Tool
title: query_sap_s_4hana_fi_benefit_enrollments
description: "Query SAP S/4HANA FI wellness, medical, and dental enrollment plans and statuses for a worker."
tags:
  - hr
  - okf
  - brd
...
# query_sap_s_4hana_fi_benefit_enrollments

Query SAP S/4HANA FI wellness, medical, and dental enrollment plans and statuses for a worker.
...
```
query_sap_s_4hana_fi_benefit_enrollments(employee_id=<employee_id>)
```
