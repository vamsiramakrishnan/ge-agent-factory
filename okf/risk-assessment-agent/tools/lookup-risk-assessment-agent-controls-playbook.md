---
type: Agent Tool
title: lookup_risk_assessment_agent_controls_playbook
...
Look up sections of the Risk Assessment Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_risk_assessment_agent_controls_playbook(section_anchor=<section_anchor>)
```
