---
type: Agent Tool
title: lookup_what_if_scenario_simulator_policy_guide
...
Look up sections of the What-If Scenario Simulator Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [question_to_parameters](/workflow/question-to-parameters.md)
- [data_assembly_simulation](/workflow/data-assembly-simulation.md)
...
```
lookup_what_if_scenario_simulator_policy_guide(section_anchor=<section_anchor>)
```
