---
type: Agent Tool
title: lookup_rolling_forecast_engine_controls_playbook
...
Look up sections of the Rolling Forecast Engine Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [qualitative_signal_adjustment](/workflow/qualitative-signal-adjustment.md)
- [delivery_distribution](/workflow/delivery-distribution.md)
...
```
lookup_rolling_forecast_engine_controls_playbook(section_anchor=<section_anchor>)
```
