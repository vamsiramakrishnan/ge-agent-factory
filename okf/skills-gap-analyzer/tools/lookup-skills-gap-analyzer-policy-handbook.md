---
type: Agent Tool
title: lookup_skills_gap_analyzer_policy_handbook
...
Look up sections of the Skills Gap Analyzer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_skills_gap_analyzer_policy_handbook(section_anchor=<section_anchor>)
```
