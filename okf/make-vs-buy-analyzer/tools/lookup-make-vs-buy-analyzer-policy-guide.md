---
type: Agent Tool
title: lookup_make_vs_buy_analyzer_policy_guide
...
Look up sections of the Make-vs-Buy Analyzer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_make_vs_buy_analyzer_policy_guide(section_anchor=<section_anchor>)
```
