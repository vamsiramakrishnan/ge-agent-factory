...
description: Retrieve dashboards from Looker for the Revenue Leakage Detection Analyzer workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve dashboards from Looker for the Revenue Leakage Detection Analyzer workflow.
