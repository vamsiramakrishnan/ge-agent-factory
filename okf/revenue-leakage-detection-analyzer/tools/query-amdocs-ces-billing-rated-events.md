...
description: Retrieve rated events from Amdocs CES Billing for the Revenue Leakage Detection Analyzer workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve rated events from Amdocs CES Billing for the Revenue Leakage Detection Analyzer workflow.
