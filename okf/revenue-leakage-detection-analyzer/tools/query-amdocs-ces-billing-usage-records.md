...
description: Retrieve usage records from Amdocs CES Billing for the Revenue Leakage Detection Analyzer workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve usage records from Amdocs CES Billing for the Revenue Leakage Detection Analyzer workflow.
