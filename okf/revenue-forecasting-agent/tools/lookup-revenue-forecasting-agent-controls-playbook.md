---
type: Agent Tool
title: lookup_revenue_forecasting_agent_controls_playbook
...
Look up sections of the Revenue Forecasting Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [win_rate_regression](/workflow/win-rate-regression.md)
...
```
lookup_revenue_forecasting_agent_controls_playbook(section_anchor=<section_anchor>)
```
