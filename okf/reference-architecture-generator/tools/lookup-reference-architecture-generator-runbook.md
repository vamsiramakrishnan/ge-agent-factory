---
type: Agent Tool
title: lookup_reference_architecture_generator_runbook
...
Look up sections of the Reference Architecture Generator Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_reference_architecture_generator_runbook(section_anchor=<section_anchor>)
```
