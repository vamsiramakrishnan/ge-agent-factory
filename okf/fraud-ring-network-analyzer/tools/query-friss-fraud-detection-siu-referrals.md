...
description: Retrieve siu referrals from FRISS Fraud Detection for the Fraud Ring Network Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve siu referrals from FRISS Fraud Detection for the Fraud Ring Network Analyzer workflow.
