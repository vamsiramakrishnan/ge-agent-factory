...
description: Retrieve mvr records from LexisNexis Risk Solutions for the Fraud Ring Network Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve mvr records from LexisNexis Risk Solutions for the Fraud Ring Network Analyzer workflow.
