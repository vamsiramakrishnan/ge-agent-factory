...
description: Retrieve analytics events from BigQuery for the Fraud Ring Network Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Fraud Ring Network Analyzer workflow.
