---
type: Agent Tool
title: action_friss_fraud_detection_file
description: Execute the file step in FRISS Fraud Detection after the agent has gathered evidence and validated escalation gates.
tags:
  - insurance
  - okf
  - brd
...
# action_friss_fraud_detection_file

Execute the file step in FRISS Fraud Detection after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [FRISS Fraud Detection](/systems/friss-fraud-detection.md)
- **API:** POST /api/friss_fraud_detection/file
...
```
action_friss_fraud_detection_file(target_id=<target_id>, rationale=<rationale>)
```
