---
type: Eval Scenario
title: While running the Early Delinquency Outreach Orchestrator workflow you encoun...
description: "While running the Early Delinquency Outreach Orchestrator workflow you encounter this condition: Aggregate committed exposure to the borrower and its obligor group would exceed the house limit of $10,000,000 or any single advance exceeds 15% of unimpaired capital (legal lending limit). Handle it end to end."
source_id: "early-delinquency-outreach-orchestrator-escalation-path"
