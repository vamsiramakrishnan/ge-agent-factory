...
description: Retrieve cost changes from Oracle Retail MFCS for the New Item Launch Orchestrator workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cost changes from Oracle Retail MFCS for the New Item Launch Orchestrator workflow.
