...
provenance_source_ref: "apps/factory/catalog/interview-specs/new-item-launch-orchestrator.json"
...
> R-1104 • Merchandising & Assortment
...
- **Item setup cycle time**: 12 days → 36 hours
- **Launch-week on-shelf availability**: 77% → 96%
- **Item data error rate at setup**: 9% → 0.8%
