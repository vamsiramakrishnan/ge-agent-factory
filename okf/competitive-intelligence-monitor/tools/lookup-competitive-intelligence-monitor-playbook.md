---
type: Agent Tool
title: lookup_competitive_intelligence_monitor_playbook
...
Look up sections of the Competitive Intelligence Monitor Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_competitive_intelligence_monitor_playbook(section_anchor=<section_anchor>)
```
