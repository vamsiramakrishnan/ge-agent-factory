...
description: Retrieve agent schedules from Genesys Cloud CX for the Churn Save Desk Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve agent schedules from Genesys Cloud CX for the Churn Save Desk Agent workflow.
