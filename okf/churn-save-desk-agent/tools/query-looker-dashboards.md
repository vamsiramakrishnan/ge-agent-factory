...
description: Retrieve dashboards from Looker for the Churn Save Desk Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve dashboards from Looker for the Churn Save Desk Agent workflow.
