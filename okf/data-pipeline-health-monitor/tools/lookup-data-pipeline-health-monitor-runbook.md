---
type: Agent Tool
title: lookup_data_pipeline_health_monitor_runbook
...
Look up sections of the Data Pipeline Health Monitor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_data_pipeline_health_monitor_runbook(section_anchor=<section_anchor>)
```
