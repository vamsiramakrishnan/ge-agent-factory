---
type: Agent Tool
title: lookup_continuous_controls_monitor_controls_playbook
...
Look up sections of the Continuous Controls Monitor Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_continuous_controls_monitor_controls_playbook(section_anchor=<section_anchor>)
```
