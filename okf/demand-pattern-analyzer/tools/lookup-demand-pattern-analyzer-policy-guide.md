---
type: Agent Tool
title: lookup_demand_pattern_analyzer_policy_guide
...
Look up sections of the Demand Pattern Analyzer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [time_series_decomposition](/workflow/time-series-decomposition.md)
...
```
lookup_demand_pattern_analyzer_policy_guide(section_anchor=<section_anchor>)
```
