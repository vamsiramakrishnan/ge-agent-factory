...
description: Retrieve capa actions from SAP S/4HANA QM for the Batch Record Review Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve capa actions from SAP S/4HANA QM for the Batch Record Review Analyzer workflow.
