...
description: Retrieve analytics events from BigQuery for the Batch Record Review Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Batch Record Review Analyzer workflow.
