...
description: Retrieve production orders from Siemens Opcenter MES for the Batch Record Review Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve production orders from Siemens Opcenter MES for the Batch Record Review Analyzer workflow.
