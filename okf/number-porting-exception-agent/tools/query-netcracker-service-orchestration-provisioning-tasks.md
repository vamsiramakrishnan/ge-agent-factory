...
description: Retrieve provisioning tasks from Netcracker Service Orchestration for the Number Porting Exception Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve provisioning tasks from Netcracker Service Orchestration for the Number Porting Exception Agent workflow.
