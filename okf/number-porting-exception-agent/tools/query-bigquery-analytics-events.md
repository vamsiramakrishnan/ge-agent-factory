...
description: Retrieve analytics events from BigQuery for the Number Porting Exception Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Number Porting Exception Agent workflow.
