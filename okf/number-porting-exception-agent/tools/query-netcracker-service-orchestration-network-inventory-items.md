...
description: Retrieve network inventory items from Netcracker Service Orchestration for the Number Porting Exception Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve network inventory items from Netcracker Service Orchestration for the Number Porting Exception Agent workflow.
