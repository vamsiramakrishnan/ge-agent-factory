...
provenance_source_ref: "apps/factory/catalog/interview-specs/number-porting-exception-agent.json"
...
> T-4203 • Order Management & Provisioning
...
- **Port-in rejection rate**: 22% → 7%
- **Average port completion time**: 5.5 days → 1.8 days
- **Porting escalations to regulator**: 35/quarter → 6/quarter
