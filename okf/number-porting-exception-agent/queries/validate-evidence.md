...
title: "Cross-check every finding against the Number Porting Exception Agent Service ..."
description: "Cross-check every finding against the Number Porting Exception Agent Service Assurance Runbook and cite the governing sections before any recommendation is issued."
...
# Cross-check every finding against the Number Porting Exception Agent Service Assurance Runbook and cite the governing sections before any recommendation is issued.
