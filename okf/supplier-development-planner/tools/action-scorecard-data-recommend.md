---
type: Agent Tool
title: action_scorecard_data_recommend
...
Execute the recommend step in Scorecard Data after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Scorecard Data](/systems/scorecard-data.md)
- **API:** POST /api/scorecard_data/recommend
...
```
action_scorecard_data_recommend(target_id=<target_id>, rationale=<rationale>)
```
