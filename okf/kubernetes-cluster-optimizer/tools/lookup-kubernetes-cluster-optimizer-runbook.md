---
type: Agent Tool
title: lookup_kubernetes_cluster_optimizer_runbook
...
Look up sections of the Kubernetes Cluster Optimizer Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_kubernetes_cluster_optimizer_runbook(section_anchor=<section_anchor>)
```
