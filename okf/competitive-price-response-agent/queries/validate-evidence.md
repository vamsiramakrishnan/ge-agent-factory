...
title: "Cross-check every finding against the Competitive Price Response Agent Retail..."
description: "Cross-check every finding against the Competitive Price Response Agent Retail Execution Playbook and cite the governing sections before any recommendation is issued."
...
# Cross-check every finding against the Competitive Price Response Agent Retail Execution Playbook and cite the governing sections before any recommendation is issued.
