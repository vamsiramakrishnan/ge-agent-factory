...
description: Retrieve dashboards from Looker for the Competitive Price Response Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve dashboards from Looker for the Competitive Price Response Agent workflow.
