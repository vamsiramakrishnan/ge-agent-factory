...
description: Retrieve price zones from Revionics Price Optimization for the Competitive Price Response Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve price zones from Revionics Price Optimization for the Competitive Price Response Agent workflow.
