...
description: Retrieve elasticity models from Revionics Price Optimization for the Competitive Price Response Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve elasticity models from Revionics Price Optimization for the Competitive Price Response Agent workflow.
