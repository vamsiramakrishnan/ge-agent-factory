...
description: Retrieve analytics events from BigQuery for the Competitive Price Response Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Competitive Price Response Agent workflow.
