---
type: Agent Tool
title: lookup_engagement_to_outcome_correlation_agent_policy_handbook
...
Look up sections of the Engagement-to-Outcome Correlation Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_engagement_to_outcome_correlation_agent_policy_handbook(section_anchor=<section_anchor>)
```
