---
type: Agent Tool
title: lookup_product_profitability_analyzer_controls_playbook
...
Look up sections of the Product Profitability Analyzer Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [dashboard_refresh](/workflow/dashboard-refresh.md)
...
```
lookup_product_profitability_analyzer_controls_playbook(section_anchor=<section_anchor>)
```
