...
description: Retrieve analytics events from BigQuery for the Wire Exception Repair Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Wire Exception Repair Agent workflow.
