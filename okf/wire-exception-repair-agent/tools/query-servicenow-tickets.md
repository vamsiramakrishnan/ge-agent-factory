...
description: Retrieve tickets from ServiceNow for the Wire Exception Repair Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Wire Exception Repair Agent workflow.
