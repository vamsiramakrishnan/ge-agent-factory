...
description: Retrieve analytics events from BigQuery for the Inventory Rebalancing Orchestrator workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Inventory Rebalancing Orchestrator workflow.
