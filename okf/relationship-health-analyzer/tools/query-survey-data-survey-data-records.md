---
type: Agent Tool
title: query_survey_data_survey_data_records
...
Retrieve survey data records from Survey Data for the Relationship Health Analyzer workflow.

- **Kind:** query
- **Source system:** [Survey Data](/systems/survey-data.md)
...
No explicit permission scopes declared; source-system access is tied to [Survey Data](/systems/survey-data.md).
...
```
query_survey_data_survey_data_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Survey Data](/systems/survey-data.md)
