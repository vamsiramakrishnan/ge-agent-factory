---
type: Agent Tool
title: lookup_agreement_hierarchy_tracker_policy_guide
...
Look up sections of the Agreement Hierarchy Tracker Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_agreement_hierarchy_tracker_policy_guide(section_anchor=<section_anchor>)
```
