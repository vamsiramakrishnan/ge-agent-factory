...
description: Retrieve permit records from Sphera EHS for the Regulatory Emissions Reporting Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve permit records from Sphera EHS for the Regulatory Emissions Reporting Agent workflow.
