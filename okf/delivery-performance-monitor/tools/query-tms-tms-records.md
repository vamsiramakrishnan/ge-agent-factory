...
Retrieve tms records from TMS for the Delivery Performance Monitor workflow.

- **Kind:** query
- **Source system:** [TMS](/systems/tms.md)
...
No explicit permission scopes declared; source-system access is tied to [TMS](/systems/tms.md).
...
```
query_tms_tms_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
