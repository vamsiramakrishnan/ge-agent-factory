---
type: Agent Tool
title: action_sap_s_4hana_mm_me21n_match
...
Execute the match step in SAP S/4HANA MM (ME21N) after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [SAP S/4HANA MM (ME21N)](/systems/sap-s-4hana-mm-me21n.md)
- **API:** POST /api/sap_s_4hana_mm_me21n/match
...
- May change SAP S/4HANA MM (ME21N) state because the spec classifies it as action.
...
```
action_sap_s_4hana_mm_me21n_match(target_id=<target_id>, rationale=<rationale>)
```
