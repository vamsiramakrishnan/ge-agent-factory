...
title: "Draft the waiver memo and trend narrative for breached or near-breach covenan..."
description: "Draft the waiver memo and trend narrative for breached or near-breach covenant_records, then execute action_ncino_loan_origination_escalate in nCino Loan Origination with a full audit trail routed to the Credit Risk Officer or special assets group."
source_id: "escalation-waiver-memo-drafting"
...
# Draft the waiver memo and trend narrative for breached or near-breach covenant_records, then execute action_ncino_loan_origination_escalate in nCino Loan Origination with a full audit trail routed to the Credit Risk Officer or special assets group.
