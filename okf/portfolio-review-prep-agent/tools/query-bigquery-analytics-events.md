...
description: Retrieve analytics events from BigQuery for the Portfolio Review Preparation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Portfolio Review Preparation Agent workflow.
