...
description: Retrieve financial accounts from Salesforce Financial Services Cloud for the Portfolio Review Preparation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve financial accounts from Salesforce Financial Services Cloud for the Portfolio Review Preparation Agent workflow.
