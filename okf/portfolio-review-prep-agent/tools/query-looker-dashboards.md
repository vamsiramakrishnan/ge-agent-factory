...
description: Retrieve dashboards from Looker for the Portfolio Review Preparation Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve dashboards from Looker for the Portfolio Review Preparation Agent workflow.
