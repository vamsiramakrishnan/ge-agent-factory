---
type: Agent Tool
title: query_oracle_oracle_records
...
Retrieve oracle records from Oracle for the Requisition Intake & Smart Routing workflow.

- **Kind:** query
- **Source system:** [Oracle](/systems/oracle.md)
...
No explicit permission scopes declared; source-system access is tied to [Oracle](/systems/oracle.md).
...
```
query_oracle_oracle_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Oracle](/systems/oracle.md)
