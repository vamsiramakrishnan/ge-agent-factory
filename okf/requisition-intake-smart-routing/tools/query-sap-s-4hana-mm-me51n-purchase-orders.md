---
type: Agent Tool
title: query_sap_s_4hana_mm_me51n_purchase_orders
...
Retrieve purchase orders from SAP S/4HANA MM (ME51N) for the Requisition Intake & Smart Routing workflow.
...
```
query_sap_s_4hana_mm_me51n_purchase_orders(lookup_key=<lookup_key>, date_range=<date_range>)
```
