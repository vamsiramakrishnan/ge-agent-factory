...
description: Retrieve analytics events from BigQuery for the AP Aging Analyzer workflow.
tags:
  - finance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the AP Aging Analyzer workflow.
