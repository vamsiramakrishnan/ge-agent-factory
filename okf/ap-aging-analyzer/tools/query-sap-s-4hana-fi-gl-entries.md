...
description: Retrieve gl entries from SAP S/4HANA FI for the AP Aging Analyzer workflow.
tags:
  - finance
  - okf
  - brd
...
Retrieve gl entries from SAP S/4HANA FI for the AP Aging Analyzer workflow.
