---
type: Playbook
title: Supplier Consolidation Analyzer — Playbook
description: Operating contract for the Supplier Consolidation Analyzer agent.
tags:
  - procurement
  - okf
  - brd
...
Category Manager agent for the Supplier Consolidation Analyzer workflow
...
| --- | --- | --- |
| Consolidation analysis time regresses past the 4-6 weeks baseline by more than 20% | escalate_to_human | Significant regressions need human judgment before automated remediation runs against production records. |
