---
type: Agent Tool
title: action_salesforce_crm_route
...
Execute the route step in Salesforce CRM after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Salesforce CRM](/systems/salesforce-crm.md)
- **API:** POST /api/salesforce_crm/route
...
```
action_salesforce_crm_route(target_id=<target_id>, rationale=<rationale>)
```
