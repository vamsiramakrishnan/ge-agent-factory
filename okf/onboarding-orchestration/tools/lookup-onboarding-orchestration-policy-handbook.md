---
type: Agent Tool
title: lookup_onboarding_orchestration_policy_handbook
...
Look up sections of the Onboarding Orchestration Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_onboarding_orchestration_policy_handbook(section_anchor=<section_anchor>)
```
