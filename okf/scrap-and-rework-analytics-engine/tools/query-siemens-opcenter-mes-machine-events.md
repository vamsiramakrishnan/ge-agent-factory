...
description: Retrieve machine events from Siemens Opcenter MES for the Scrap and Rework Analytics Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve machine events from Siemens Opcenter MES for the Scrap and Rework Analytics Engine workflow.
