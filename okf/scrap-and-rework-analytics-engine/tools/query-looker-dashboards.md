...
description: Retrieve dashboards from Looker for the Scrap and Rework Analytics Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve dashboards from Looker for the Scrap and Rework Analytics Engine workflow.
