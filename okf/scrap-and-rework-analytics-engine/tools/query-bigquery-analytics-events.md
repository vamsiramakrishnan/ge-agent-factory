...
description: Retrieve analytics events from BigQuery for the Scrap and Rework Analytics Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Scrap and Rework Analytics Engine workflow.
