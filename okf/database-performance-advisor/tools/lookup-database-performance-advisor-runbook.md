---
type: Agent Tool
title: lookup_database_performance_advisor_runbook
...
Look up sections of the Database Performance Advisor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [query_plan_index_analysis](/workflow/query-plan-index-analysis.md)
- [application_verification](/workflow/application-verification.md)
...
```
lookup_database_performance_advisor_runbook(section_anchor=<section_anchor>)
```
