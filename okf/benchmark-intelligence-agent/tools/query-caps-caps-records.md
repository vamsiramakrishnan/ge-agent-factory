...
Retrieve caps records from CAPS for the Benchmark Intelligence Agent workflow.

- **Kind:** query
- **Source system:** [CAPS](/systems/caps.md)
...
No explicit permission scopes declared; source-system access is tied to [CAPS](/systems/caps.md).
...
```
query_caps_caps_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [CAPS](/systems/caps.md)
