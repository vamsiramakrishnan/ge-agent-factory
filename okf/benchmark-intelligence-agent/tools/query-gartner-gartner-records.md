---
type: Agent Tool
title: query_gartner_gartner_records
...
Retrieve gartner records from Gartner for the Benchmark Intelligence Agent workflow.
...
```
query_gartner_gartner_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
