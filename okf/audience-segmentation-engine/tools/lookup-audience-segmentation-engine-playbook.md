---
type: Agent Tool
title: lookup_audience_segmentation_engine_playbook
...
Look up sections of the Audience Segmentation Engine Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [clustering_scoring](/workflow/clustering-scoring.md)
...
```
lookup_audience_segmentation_engine_playbook(section_anchor=<section_anchor>)
```
