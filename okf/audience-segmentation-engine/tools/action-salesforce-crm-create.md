---
type: Agent Tool
title: action_salesforce_crm_create
...
Execute the create step in Salesforce CRM after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Salesforce CRM](/systems/salesforce-crm.md)
- **API:** POST /api/salesforce_crm/create
...
```
action_salesforce_crm_create(target_id=<target_id>, rationale=<rationale>)
```
