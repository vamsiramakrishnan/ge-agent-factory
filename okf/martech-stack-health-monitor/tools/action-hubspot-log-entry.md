---
type: Agent Tool
title: action_hubspot_log_entry
...
Execute the log entry step in HubSpot after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [HubSpot](/systems/hubspot.md)
- **API:** POST /api/hubspot/log_entry
...
```
action_hubspot_log_entry(target_id=<target_id>, rationale=<rationale>)
```
