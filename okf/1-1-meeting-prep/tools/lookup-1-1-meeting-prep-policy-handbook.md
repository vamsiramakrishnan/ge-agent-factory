---
type: Agent Tool
title: lookup_1_1_meeting_prep_policy_handbook
...
Look up sections of the 1:1 Meeting Prep Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_1_1_meeting_prep_policy_handbook(section_anchor=<section_anchor>)
```
