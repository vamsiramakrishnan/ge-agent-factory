---
type: Agent Tool
title: lookup_calibration_analytics_agent_policy_handbook
...
Look up sections of the Calibration Analytics Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_calibration_analytics_agent_policy_handbook(section_anchor=<section_anchor>)
```
