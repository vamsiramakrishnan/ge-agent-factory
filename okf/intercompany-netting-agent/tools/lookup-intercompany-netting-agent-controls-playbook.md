---
type: Agent Tool
title: lookup_intercompany_netting_agent_controls_playbook
...
Look up sections of the Intercompany Netting Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_intercompany_netting_agent_controls_playbook(section_anchor=<section_anchor>)
```
