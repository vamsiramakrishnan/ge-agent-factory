...
description: Retrieve payment plans from Guidewire BillingCenter for the Unapplied Cash Resolution Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve payment plans from Guidewire BillingCenter for the Unapplied Cash Resolution Agent workflow.
