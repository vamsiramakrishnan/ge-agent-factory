...
description: Retrieve insurance 3 records from INSURANCE 3 for the Unapplied Cash Resolution Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve insurance 3 records from INSURANCE 3 for the Unapplied Cash Resolution Agent workflow.
