---
type: Agent Tool
title: lookup_er_case_analytics_agent_policy_handbook
...
Look up sections of the ER Case Analytics Agent Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [pattern_trend_analysis](/workflow/pattern-trend-analysis.md)
...
```
lookup_er_case_analytics_agent_policy_handbook(section_anchor=<section_anchor>)
```
