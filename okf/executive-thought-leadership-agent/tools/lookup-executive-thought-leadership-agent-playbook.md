---
type: Agent Tool
title: lookup_executive_thought_leadership_agent_playbook
...
Look up sections of the Executive Thought Leadership Agent Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [engagement_prediction](/workflow/engagement-prediction.md)
- [voice_matched_drafting](/workflow/voice-matched-drafting.md)
...
```
lookup_executive_thought_leadership_agent_playbook(section_anchor=<section_anchor>)
```
