---
type: Agent Tool
title: lookup_change_communication_drafter_policy_handbook
...
Look up sections of the Change Communication Drafter Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_change_communication_drafter_policy_handbook(section_anchor=<section_anchor>)
```
