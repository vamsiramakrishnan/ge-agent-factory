...
description: "Retrieve analytics events from BigQuery for the Unplanned Downtime Root-Cause Agent workflow."
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Unplanned Downtime Root-Cause Agent workflow.
