---
type: Agent Tool
title: lookup_marketing_compliance_consent_manager_playbook
...
Look up sections of the Marketing Compliance & Consent Manager Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_marketing_compliance_consent_manager_playbook(section_anchor=<section_anchor>)
```
