---
type: Agent Tool
title: lookup_email_deliverability_manager_playbook
...
Look up sections of the Email Deliverability Manager Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_email_deliverability_manager_playbook(section_anchor=<section_anchor>)
```
