---
type: Agent Tool
title: lookup_policy_drafting_review_assistant_policy_handbook
...
Look up sections of the Policy Drafting & Review Assistant Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [requirements_definition](/workflow/requirements-definition.md)
...
```
lookup_policy_drafting_review_assistant_policy_handbook(section_anchor=<section_anchor>)
```
