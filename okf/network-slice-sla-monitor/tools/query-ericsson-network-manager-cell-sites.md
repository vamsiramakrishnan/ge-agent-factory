...
description: Retrieve cell sites from Ericsson Network Manager for the 5G Network Slice SLA Monitor workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve cell sites from Ericsson Network Manager for the 5G Network Slice SLA Monitor workflow.
