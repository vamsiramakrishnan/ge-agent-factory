...
description: Retrieve analytics events from BigQuery for the Card Dispute Chargeback Orchestrator workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Card Dispute Chargeback Orchestrator workflow.
