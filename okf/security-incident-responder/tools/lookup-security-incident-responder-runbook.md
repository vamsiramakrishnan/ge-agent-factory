---
type: Agent Tool
title: lookup_security_incident_responder_runbook
...
Look up sections of the Security Incident Responder Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_security_incident_responder_runbook(section_anchor=<section_anchor>)
```
