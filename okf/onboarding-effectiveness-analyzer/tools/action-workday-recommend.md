---
type: Agent Tool
title: action_workday_recommend
...
Execute the recommend step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/recommend
...
- [early_warning_dashboards](/workflow/early-warning-dashboards.md)
...
```
action_workday_recommend(target_id=<target_id>, rationale=<rationale>)
```
