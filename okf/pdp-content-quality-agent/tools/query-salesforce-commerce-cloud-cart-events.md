...
description: Retrieve cart events from Salesforce Commerce Cloud for the PDP Content Quality Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cart events from Salesforce Commerce Cloud for the PDP Content Quality Agent workflow.
