...
description: Retrieve product catalog entries from Salesforce Commerce Cloud for the PDP Content Quality Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve product catalog entries from Salesforce Commerce Cloud for the PDP Content Quality Agent workflow.
