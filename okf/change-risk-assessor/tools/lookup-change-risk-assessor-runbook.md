---
type: Agent Tool
title: lookup_change_risk_assessor_runbook
...
Look up sections of the Change Risk Assessor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_change_risk_assessor_runbook(section_anchor=<section_anchor>)
```
