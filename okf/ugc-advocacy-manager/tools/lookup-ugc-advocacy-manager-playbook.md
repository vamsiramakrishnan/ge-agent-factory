---
type: Agent Tool
title: lookup_ugc_advocacy_manager_playbook
...
Look up sections of the UGC & Advocacy Manager Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_ugc_advocacy_manager_playbook(section_anchor=<section_anchor>)
```
