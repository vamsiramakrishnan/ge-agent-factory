---
type: Agent Tool
title: lookup_fp_a_query_assistant_controls_playbook
...
Look up sections of the FP&A Query Assistant Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_fp_a_query_assistant_controls_playbook(section_anchor=<section_anchor>)
```
