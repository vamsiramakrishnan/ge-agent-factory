...
Execute the generate step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/generate
...
```
action_workday_generate(target_id=<target_id>, rationale=<rationale>)
```
