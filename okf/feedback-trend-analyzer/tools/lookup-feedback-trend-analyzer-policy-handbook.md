---
type: Agent Tool
title: lookup_feedback_trend_analyzer_policy_handbook
...
Look up sections of the Feedback Trend Analyzer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [nlp_theme_extraction](/workflow/nlp-theme-extraction.md)
...
```
lookup_feedback_trend_analyzer_policy_handbook(section_anchor=<section_anchor>)
```
