---
type: Agent Tool
title: lookup_debt_covenant_tracker_controls_playbook
...
Look up sections of the Debt Covenant Tracker Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_debt_covenant_tracker_controls_playbook(section_anchor=<section_anchor>)
```
