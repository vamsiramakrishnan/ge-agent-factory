---
type: Agent Tool
title: lookup_multi_touch_attribution_engine_playbook
...
Look up sections of the Multi-Touch Attribution Engine Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [attribution_model_execution](/workflow/attribution-model-execution.md)
- [business_context_interpretation](/workflow/business-context-interpretation.md)
...
```
lookup_multi_touch_attribution_engine_playbook(section_anchor=<section_anchor>)
```
