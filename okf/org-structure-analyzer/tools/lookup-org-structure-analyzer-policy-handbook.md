---
type: Agent Tool
title: lookup_org_structure_analyzer_policy_handbook
...
Look up sections of the Org Structure Analyzer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [spans_layers_analysis](/workflow/spans-layers-analysis.md)
...
```
lookup_org_structure_analyzer_policy_handbook(section_anchor=<section_anchor>)
```
