...
description: Retrieve tickets from ServiceNow for the Wealth Client Onboarding Orchestrator workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Wealth Client Onboarding Orchestrator workflow.
