---
type: Agent Tool
title: query_coupa_pay_requisitions
...
Retrieve requisitions from Coupa Pay for the Three-Way Match Exception Handler workflow.

- **Kind:** query
- **Source system:** [Coupa Pay](/systems/coupa-pay.md)
...
No explicit permission scopes declared; source-system access is tied to [Coupa Pay](/systems/coupa-pay.md).
...
```
query_coupa_pay_requisitions(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Coupa Pay](/systems/coupa-pay.md)
