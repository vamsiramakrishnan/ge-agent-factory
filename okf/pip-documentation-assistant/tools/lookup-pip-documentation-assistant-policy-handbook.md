---
type: Agent Tool
title: lookup_pip_documentation_assistant_policy_handbook
...
Look up sections of the PIP Documentation Assistant Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_pip_documentation_assistant_policy_handbook(section_anchor=<section_anchor>)
```
