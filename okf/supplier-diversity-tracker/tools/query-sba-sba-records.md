...
Retrieve sba records from SBA for the Supplier Diversity Tracker workflow.

- **Kind:** query
- **Source system:** [SBA](/systems/sba.md)
...
No explicit permission scopes declared; source-system access is tied to [SBA](/systems/sba.md).
...
```
query_sba_sba_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
