---
type: Agent Tool
title: lookup_supplier_diversity_tracker_policy_guide
...
Look up sections of the Supplier Diversity Tracker Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_supplier_diversity_tracker_policy_guide(section_anchor=<section_anchor>)
```
