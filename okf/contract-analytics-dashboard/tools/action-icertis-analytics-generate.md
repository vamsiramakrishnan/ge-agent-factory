---
type: Agent Tool
title: action_icertis_analytics_generate
...
Execute the generate step in Icertis Analytics after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Icertis Analytics](/systems/icertis-analytics.md)
- **API:** POST /api/icertis_analytics/generate
...
- May change Icertis Analytics state because the spec classifies it as action.
...
```
action_icertis_analytics_generate(target_id=<target_id>, rationale=<rationale>)
```
