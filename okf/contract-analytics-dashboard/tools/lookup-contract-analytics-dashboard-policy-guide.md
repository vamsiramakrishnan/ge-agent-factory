---
type: Agent Tool
title: lookup_contract_analytics_dashboard_policy_guide
...
Look up sections of the Contract Analytics Dashboard Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_contract_analytics_dashboard_policy_guide(section_anchor=<section_anchor>)
```
