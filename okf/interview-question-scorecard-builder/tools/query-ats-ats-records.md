...
Retrieve ats records from ATS for the Interview Question & Scorecard Builder workflow.
...
```
query_ats_ats_records(lookup_key=<lookup_key>, date_range=<date_range>)
```
