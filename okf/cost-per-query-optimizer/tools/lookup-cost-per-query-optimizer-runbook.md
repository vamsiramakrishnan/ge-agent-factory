---
type: Agent Tool
title: lookup_cost_per_query_optimizer_runbook
...
Look up sections of the Cost-per-Query Optimizer Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [optimization_opportunity_detection](/workflow/optimization-opportunity-detection.md)
- [implementation_guidance](/workflow/implementation-guidance.md)
- [savings_tracking](/workflow/savings-tracking.md)
...
```
lookup_cost_per_query_optimizer_runbook(section_anchor=<section_anchor>)
```
