---
type: Agent Tool
title: lookup_peer_benchmarking_agent_controls_playbook
...
Look up sections of the Peer Benchmarking Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [ratio_ranking_analysis](/workflow/ratio-ranking-analysis.md)
...
```
lookup_peer_benchmarking_agent_controls_playbook(section_anchor=<section_anchor>)
```
