---
type: Agent Tool
title: lookup_policy_compliance_scanner_controls_playbook
...
Look up sections of the Policy Compliance Scanner Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_policy_compliance_scanner_controls_playbook(section_anchor=<section_anchor>)
```
