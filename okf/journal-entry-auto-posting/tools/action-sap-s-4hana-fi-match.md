---
type: Agent Tool
title: action_sap_s_4hana_fi_match
...
Execute the match step in SAP S/4HANA FI after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [SAP S/4HANA FI](/systems/sap-s-4hana-fi.md)
- **API:** POST /api/sap_s_4hana_fi/match
...
```
action_sap_s_4hana_fi_match(target_id=<target_id>, rationale=<rationale>)
```
