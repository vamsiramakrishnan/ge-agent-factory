---
type: Agent Tool
title: lookup_cash_flow_forecaster_controls_playbook
...
Look up sections of the Cash Flow Forecaster Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_cash_flow_forecaster_controls_playbook(section_anchor=<section_anchor>)
```
