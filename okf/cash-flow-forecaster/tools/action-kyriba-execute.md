...
Execute the execute step in Kyriba after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Kyriba](/systems/kyriba.md)
- **API:** POST /api/kyriba/execute
...
```
action_kyriba_execute(target_id=<target_id>, rationale=<rationale>)
```
