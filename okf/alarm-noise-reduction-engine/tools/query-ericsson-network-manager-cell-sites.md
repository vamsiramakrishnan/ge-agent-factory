...
description: Retrieve cell sites from Ericsson Network Manager for the Alarm Noise Reduction Engine workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve cell sites from Ericsson Network Manager for the Alarm Noise Reduction Engine workflow.
