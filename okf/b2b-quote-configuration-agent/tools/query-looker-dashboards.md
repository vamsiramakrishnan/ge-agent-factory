...
description: Retrieve dashboards from Looker for the B2B Quote Configuration Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve dashboards from Looker for the B2B Quote Configuration Agent workflow.
