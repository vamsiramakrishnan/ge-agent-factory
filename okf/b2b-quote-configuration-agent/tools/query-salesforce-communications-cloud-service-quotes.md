...
description: Retrieve service quotes from Salesforce Communications Cloud for the B2B Quote Configuration Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve service quotes from Salesforce Communications Cloud for the B2B Quote Configuration Agent workflow.
