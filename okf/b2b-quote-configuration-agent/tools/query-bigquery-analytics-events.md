...
description: Retrieve analytics events from BigQuery for the B2B Quote Configuration Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the B2B Quote Configuration Agent workflow.
