...
description: Retrieve documents from Google Docs for the Compensation Letter Generator workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve documents from Google Docs for the Compensation Letter Generator workflow.
