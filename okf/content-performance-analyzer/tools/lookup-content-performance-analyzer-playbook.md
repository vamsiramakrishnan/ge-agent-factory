---
type: Agent Tool
title: lookup_content_performance_analyzer_playbook
...
Look up sections of the Content Performance Analyzer Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [decay_performance_scoring](/workflow/decay-performance-scoring.md)
- [root_cause_diagnosis](/workflow/root-cause-diagnosis.md)
- [report_dashboard](/workflow/report-dashboard.md)
...
```
lookup_content_performance_analyzer_playbook(section_anchor=<section_anchor>)
```
