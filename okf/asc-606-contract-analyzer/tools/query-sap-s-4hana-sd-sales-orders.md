---
type: Agent Tool
title: query_sap_s_4hana_sd_sales_orders
...
Retrieve sales orders from SAP S/4HANA SD for the ASC 606 Contract Analyzer workflow.
...
```
query_sap_s_4hana_sd_sales_orders(lookup_key=<lookup_key>, date_range=<date_range>)
```
