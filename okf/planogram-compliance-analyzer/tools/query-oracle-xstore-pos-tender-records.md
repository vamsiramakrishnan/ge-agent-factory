...
description: Retrieve tender records from Oracle Xstore POS for the Planogram Compliance Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve tender records from Oracle Xstore POS for the Planogram Compliance Analyzer workflow.
