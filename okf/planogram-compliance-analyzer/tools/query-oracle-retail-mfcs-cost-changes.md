...
description: Retrieve cost changes from Oracle Retail MFCS for the Planogram Compliance Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cost changes from Oracle Retail MFCS for the Planogram Compliance Analyzer workflow.
