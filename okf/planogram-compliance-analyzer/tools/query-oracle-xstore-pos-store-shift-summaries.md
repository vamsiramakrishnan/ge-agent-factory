...
description: Retrieve store shift summaries from Oracle Xstore POS for the Planogram Compliance Analyzer workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve store shift summaries from Oracle Xstore POS for the Planogram Compliance Analyzer workflow.
