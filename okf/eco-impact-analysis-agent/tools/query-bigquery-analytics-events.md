...
description: Retrieve analytics events from BigQuery for the ECO Impact Analysis Agent workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the ECO Impact Analysis Agent workflow.
