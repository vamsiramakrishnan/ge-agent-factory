---
type: Agent Tool
title: lookup_learning_content_summarizer_quiz_generator_policy_handbook
...
Look up sections of the Learning Content Summarizer & Quiz Generator Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_learning_content_summarizer_quiz_generator_policy_handbook(section_anchor=<section_anchor>)
```
