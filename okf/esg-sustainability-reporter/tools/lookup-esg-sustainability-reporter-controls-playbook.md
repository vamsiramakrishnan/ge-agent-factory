---
type: Agent Tool
title: lookup_esg_sustainability_reporter_controls_playbook
...
Look up sections of the ESG & Sustainability Reporter Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_esg_sustainability_reporter_controls_playbook(section_anchor=<section_anchor>)
```
