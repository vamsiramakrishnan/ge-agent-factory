...
description: Retrieve entity profiles from Fenergo CLM for the Sanctions Screening Hit Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve entity profiles from Fenergo CLM for the Sanctions Screening Hit Analyzer workflow.
