...
description: Retrieve screening results from Fenergo CLM for the Sanctions Screening Hit Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve screening results from Fenergo CLM for the Sanctions Screening Hit Analyzer workflow.
