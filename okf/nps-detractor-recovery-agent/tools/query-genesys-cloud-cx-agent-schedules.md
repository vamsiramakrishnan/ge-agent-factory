...
description: Retrieve agent schedules from Genesys Cloud CX for the NPS Detractor Recovery Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve agent schedules from Genesys Cloud CX for the NPS Detractor Recovery Agent workflow.
