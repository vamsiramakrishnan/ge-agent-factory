...
description: Retrieve policy quotes from Guidewire PolicyCenter for the Endorsement Processing Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve policy quotes from Guidewire PolicyCenter for the Endorsement Processing Agent workflow.
