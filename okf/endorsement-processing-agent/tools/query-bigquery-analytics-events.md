...
description: Retrieve analytics events from BigQuery for the Endorsement Processing Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Endorsement Processing Agent workflow.
