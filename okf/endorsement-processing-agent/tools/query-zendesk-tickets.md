...
description: Retrieve tickets from Zendesk for the Endorsement Processing Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve tickets from Zendesk for the Endorsement Processing Agent workflow.
