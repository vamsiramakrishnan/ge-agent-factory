---
type: Agent Tool
title: query_linkedin_ads_campaigns
...
Retrieve campaigns from LinkedIn Ads for the Paid Media Optimizer workflow.
...
```
query_linkedin_ads_campaigns(lookup_key=<lookup_key>, date_range=<date_range>)
```
