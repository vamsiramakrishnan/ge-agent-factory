...
description: Retrieve billing accounts from Guidewire BillingCenter for the Agent Commission Reconciliation Engine workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve billing accounts from Guidewire BillingCenter for the Agent Commission Reconciliation Engine workflow.
