...
description: Retrieve payment plans from Guidewire BillingCenter for the Payment Plan Recommendation Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve payment plans from Guidewire BillingCenter for the Payment Plan Recommendation Agent workflow.
