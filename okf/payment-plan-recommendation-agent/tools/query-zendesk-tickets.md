...
description: Retrieve tickets from Zendesk for the Payment Plan Recommendation Agent workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve tickets from Zendesk for the Payment Plan Recommendation Agent workflow.
