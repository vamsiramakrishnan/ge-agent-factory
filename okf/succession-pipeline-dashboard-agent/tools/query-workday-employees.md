...
description: Retrieve employees from Workday for the Succession Pipeline Dashboard Agent workflow.
tags:
  - hr
  - okf
  - brd
...
Retrieve employees from Workday for the Succession Pipeline Dashboard Agent workflow.
