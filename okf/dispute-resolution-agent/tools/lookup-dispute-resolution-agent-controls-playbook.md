---
type: Agent Tool
title: lookup_dispute_resolution_agent_controls_playbook
...
Look up sections of the Dispute Resolution Agent Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [pattern_root_cause_analysis](/workflow/pattern-root-cause-analysis.md)
...
```
lookup_dispute_resolution_agent_controls_playbook(section_anchor=<section_anchor>)
```
