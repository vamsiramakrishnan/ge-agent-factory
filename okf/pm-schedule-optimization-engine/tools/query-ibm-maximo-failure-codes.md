...
description: Retrieve failure codes from IBM Maximo for the PM Schedule Optimization Engine workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve failure codes from IBM Maximo for the PM Schedule Optimization Engine workflow.
