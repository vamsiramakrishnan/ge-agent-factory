---
type: Agent Tool
title: lookup_tax_provision_calculator_controls_playbook
...
Look up sections of the Tax Provision Calculator Controls Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [approval_reporting](/workflow/approval-reporting.md)
...
```
lookup_tax_provision_calculator_controls_playbook(section_anchor=<section_anchor>)
```
