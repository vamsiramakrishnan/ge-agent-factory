---
type: Agent Tool
title: lookup_rfx_builder_orchestrator_policy_guide
...
Look up sections of the RFx Builder & Orchestrator Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_rfx_builder_orchestrator_policy_guide(section_anchor=<section_anchor>)
```
