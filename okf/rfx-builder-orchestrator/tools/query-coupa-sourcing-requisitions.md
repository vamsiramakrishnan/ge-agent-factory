---
type: Agent Tool
title: query_coupa_sourcing_requisitions
...
Retrieve requisitions from Coupa Sourcing for the RFx Builder & Orchestrator workflow.

- **Kind:** query
- **Source system:** [Coupa Sourcing](/systems/coupa-sourcing.md)
...
No explicit permission scopes declared; source-system access is tied to [Coupa Sourcing](/systems/coupa-sourcing.md).
...
```
query_coupa_sourcing_requisitions(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Coupa Sourcing](/systems/coupa-sourcing.md)
