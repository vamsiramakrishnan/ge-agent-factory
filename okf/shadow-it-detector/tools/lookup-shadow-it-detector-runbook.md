---
type: Agent Tool
title: lookup_shadow_it_detector_runbook
...
Look up sections of the Shadow IT Detector Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_shadow_it_detector_runbook(section_anchor=<section_anchor>)
```
