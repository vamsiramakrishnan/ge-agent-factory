...
description: Retrieve risk measures from Murex MX.3 for the Trade Confirmation Break Resolution Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve risk measures from Murex MX.3 for the Trade Confirmation Break Resolution Agent workflow.
