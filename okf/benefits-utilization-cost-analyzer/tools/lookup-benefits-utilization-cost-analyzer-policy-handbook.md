---
type: Agent Tool
title: lookup_benefits_utilization_cost_analyzer_policy_handbook
...
Look up sections of the Benefits Utilization & Cost Analyzer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [predictive_cost_modeling](/workflow/predictive-cost-modeling.md)
...
```
lookup_benefits_utilization_cost_analyzer_policy_handbook(section_anchor=<section_anchor>)
```
