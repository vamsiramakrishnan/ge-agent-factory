---
type: Agent Tool
title: lookup_internal_communications_drafter_playbook
...
Look up sections of the Internal Communications Drafter Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_internal_communications_drafter_playbook(section_anchor=<section_anchor>)
```
