...
description: Retrieve analytics events from BigQuery for the Beneficial Ownership Refresh Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Beneficial Ownership Refresh Agent workflow.
