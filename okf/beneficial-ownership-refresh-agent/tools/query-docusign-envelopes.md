...
description: Retrieve envelopes from DocuSign for the Beneficial Ownership Refresh Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve envelopes from DocuSign for the Beneficial Ownership Refresh Agent workflow.
