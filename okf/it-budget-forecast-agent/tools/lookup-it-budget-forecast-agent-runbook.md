---
type: Agent Tool
title: lookup_it_budget_forecast_agent_runbook
...
Look up sections of the IT Budget Forecast Agent Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_it_budget_forecast_agent_runbook(section_anchor=<section_anchor>)
```
