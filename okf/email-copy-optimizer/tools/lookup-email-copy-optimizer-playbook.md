---
type: Agent Tool
title: lookup_email_copy_optimizer_playbook
...
Look up sections of the Email Copy Optimizer Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [variant_generation](/workflow/variant-generation.md)
...
```
lookup_email_copy_optimizer_playbook(section_anchor=<section_anchor>)
```
