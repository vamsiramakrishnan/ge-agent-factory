...
description: Retrieve analytics events from BigQuery for the Premium Leakage Detection Analyzer workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Premium Leakage Detection Analyzer workflow.
