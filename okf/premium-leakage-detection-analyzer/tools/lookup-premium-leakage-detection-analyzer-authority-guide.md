---
type: Agent Tool
title: lookup_premium_leakage_detection_analyzer_authority_guide
description: "Look up sections of the Premium Leakage Detection Analyzer Authority & Referral Guide to cite in narrative output, escalation rationale, and audit evidence."
tags:
  - insurance
  - okf
  - brd
...
# lookup_premium_leakage_detection_analyzer_authority_guide

Look up sections of the Premium Leakage Detection Analyzer Authority & Referral Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_premium_leakage_detection_analyzer_authority_guide(section_anchor=<section_anchor>)
```
