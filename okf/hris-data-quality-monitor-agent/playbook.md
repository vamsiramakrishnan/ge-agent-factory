---
type: Playbook
title: HRIS Data Quality Monitor Agent — Playbook
description: Operating contract for the HRIS Data Quality Monitor Agent agent.
tags:
  - hr
  - okf
  - brd
...
HR Ops Lead agent for the HRIS Data Quality Monitor Agent workflow

## Primary objective

Continuous data quality monitoring with real-time anomaly detection. Automated duplicate identification and merge suggestions with confidence scoring. so the HR Ops Lead can move the Data quality score KPI.
...
| --- | --- | --- |
| Data quality score regresses past the Unknown baseline by more than 20% | escalate_to_human | Significant regressions need human judgment before automated remediation runs against production records. |
