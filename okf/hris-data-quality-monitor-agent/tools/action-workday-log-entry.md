---
type: Agent Tool
title: action_workday_log_entry
...
Execute the log entry step in Workday after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Workday](/systems/workday.md)
- **API:** POST /api/workday/log_entry
...
```
action_workday_log_entry(target_id=<target_id>, rationale=<rationale>)
```
