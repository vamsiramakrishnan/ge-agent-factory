---
type: Agent Tool
title: lookup_customer_voice_review_monitor_playbook
...
Look up sections of the Customer Voice & Review Monitor Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [sentiment_topic_analysis](/workflow/sentiment-topic-analysis.md)
- [product_intelligence](/workflow/product-intelligence.md)
...
```
lookup_customer_voice_review_monitor_playbook(section_anchor=<section_anchor>)
```
