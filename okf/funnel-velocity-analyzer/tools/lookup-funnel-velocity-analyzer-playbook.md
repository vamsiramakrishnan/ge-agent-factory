---
type: Agent Tool
title: lookup_funnel_velocity_analyzer_playbook
...
Look up sections of the Funnel Velocity Analyzer Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [velocity_bottleneck_analysis](/workflow/velocity-bottleneck-analysis.md)
...
```
lookup_funnel_velocity_analyzer_playbook(section_anchor=<section_anchor>)
```
