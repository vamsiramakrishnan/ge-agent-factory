---
type: Agent Tool
title: lookup_commodity_price_forecaster_policy_guide
...
Look up sections of the Commodity Price Forecaster Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [forecasting_volatility](/workflow/forecasting-volatility.md)
...
```
lookup_commodity_price_forecaster_policy_guide(section_anchor=<section_anchor>)
```
