---
type: Agent Tool
title: lookup_service_catalog_recommender_runbook
...
Look up sections of the Service Catalog Recommender Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_service_catalog_recommender_runbook(section_anchor=<section_anchor>)
```
