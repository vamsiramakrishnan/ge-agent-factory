---
type: Agent Tool
title: lookup_procurement_kpi_dashboard_policy_guide
...
Look up sections of the Procurement KPI Dashboard Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [automated_kpi_calculation](/workflow/automated-kpi-calculation.md)
...
```
lookup_procurement_kpi_dashboard_policy_guide(section_anchor=<section_anchor>)
```
