---
type: Agent Tool
title: lookup_marketing_mix_modeler_playbook
...
Look up sections of the Marketing Mix Modeler Playbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [marketing_mix_modeling](/workflow/marketing-mix-modeling.md)
- [strategy_translation](/workflow/strategy-translation.md)
...
```
lookup_marketing_mix_modeler_playbook(section_anchor=<section_anchor>)
```
