...
description: Retrieve tickets from ServiceNow for the Enterprise RFP Response Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Enterprise RFP Response Agent workflow.
