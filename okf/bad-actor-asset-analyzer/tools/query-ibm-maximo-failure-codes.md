...
description: Retrieve failure codes from IBM Maximo for the Bad Actor Asset Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve failure codes from IBM Maximo for the Bad Actor Asset Analyzer workflow.
