...
description: Retrieve analytics events from BigQuery for the Bad Actor Asset Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Bad Actor Asset Analyzer workflow.
