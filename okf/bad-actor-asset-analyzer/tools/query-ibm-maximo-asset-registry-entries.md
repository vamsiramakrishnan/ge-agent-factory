...
description: Retrieve asset registry entries from IBM Maximo for the Bad Actor Asset Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve asset registry entries from IBM Maximo for the Bad Actor Asset Analyzer workflow.
