---
type: Agent Tool
title: lookup_hr_data_lake_query_policy_handbook
...
Look up sections of the HR Data Lake Query Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_hr_data_lake_query_policy_handbook(section_anchor=<section_anchor>)
```
