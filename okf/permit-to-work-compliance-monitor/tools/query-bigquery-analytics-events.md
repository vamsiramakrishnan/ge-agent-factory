...
description: "Retrieve analytics events from BigQuery for the Permit-to-Work Compliance Monitor workflow."
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Permit-to-Work Compliance Monitor workflow.
