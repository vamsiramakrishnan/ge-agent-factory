---
type: Agent Tool
title: lookup_total_rewards_optimizer_policy_handbook
...
Look up sections of the Total Rewards Optimizer Policy Handbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_total_rewards_optimizer_policy_handbook(section_anchor=<section_anchor>)
```
