...
description: Retrieve tender records from Oracle Xstore POS for the POS Exception Triage Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve tender records from Oracle Xstore POS for the POS Exception Triage Agent workflow.
