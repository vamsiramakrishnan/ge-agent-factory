...
description: Retrieve analytics events from BigQuery for the POS Exception Triage Agent workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the POS Exception Triage Agent workflow.
