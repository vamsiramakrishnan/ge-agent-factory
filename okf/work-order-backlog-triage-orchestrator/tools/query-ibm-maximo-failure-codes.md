...
description: Retrieve failure codes from IBM Maximo for the Work Order Backlog Triage Orchestrator workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve failure codes from IBM Maximo for the Work Order Backlog Triage Orchestrator workflow.
