...
Execute the generate step in Icertis after the agent has gathered evidence and validated escalation gates.

- **Kind:** action
- **Source system:** [Icertis](/systems/icertis.md)
- **API:** POST /api/icertis/generate
...
```
action_icertis_generate(target_id=<target_id>, rationale=<rationale>)
```
