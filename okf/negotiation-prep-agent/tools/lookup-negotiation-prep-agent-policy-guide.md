---
type: Agent Tool
title: lookup_negotiation_prep_agent_policy_guide
...
Look up sections of the Negotiation Prep Agent Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_negotiation_prep_agent_policy_guide(section_anchor=<section_anchor>)
```
