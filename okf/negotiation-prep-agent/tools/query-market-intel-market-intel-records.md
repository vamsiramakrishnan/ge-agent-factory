---
type: Agent Tool
title: query_market_intel_market_intel_records
...
Retrieve market intel records from Market intel for the Negotiation Prep Agent workflow.

- **Kind:** query
- **Source system:** [Market intel](/systems/market-intel.md)
...
No explicit permission scopes declared; source-system access is tied to [Market intel](/systems/market-intel.md).
...
```
query_market_intel_market_intel_records(lookup_key=<lookup_key>, date_range=<date_range>)
```

# Citations

- [Market intel](/systems/market-intel.md)
