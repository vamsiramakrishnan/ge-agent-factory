...
title: Call lookup_advisor_next_best_action_engine_compliance_policy against the Adv...
description: "Call lookup_advisor_next_best_action_engine_compliance_policy against the Advisor Next Best Action Engine Banking Compliance Policy and the Reg BI Rollover Suitability & Concentration Playbook before any talking point is finalized."
source_id: "evidence-policy-citation-gate"
...
# Call lookup_advisor_next_best_action_engine_compliance_policy against the Advisor Next Best Action Engine Banking Compliance Policy and the Reg BI Rollover Suitability & Concentration Playbook before any talking point is finalized.
