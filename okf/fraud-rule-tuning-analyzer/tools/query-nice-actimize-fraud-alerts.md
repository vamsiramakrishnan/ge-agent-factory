...
description: Retrieve fraud alerts from NICE Actimize for the Fraud Rule Tuning Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve fraud alerts from NICE Actimize for the Fraud Rule Tuning Analyzer workflow.
