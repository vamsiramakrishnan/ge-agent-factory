...
description: Retrieve transaction risk scores from NICE Actimize for the Fraud Rule Tuning Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve transaction risk scores from NICE Actimize for the Fraud Rule Tuning Analyzer workflow.
