...
description: Retrieve investigation cases from NICE Actimize for the Fraud Rule Tuning Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve investigation cases from NICE Actimize for the Fraud Rule Tuning Analyzer workflow.
