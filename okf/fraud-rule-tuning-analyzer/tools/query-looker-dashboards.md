...
description: Retrieve dashboards from Looker for the Fraud Rule Tuning Analyzer workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve dashboards from Looker for the Fraud Rule Tuning Analyzer workflow.
