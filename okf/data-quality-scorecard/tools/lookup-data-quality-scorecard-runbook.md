---
type: Agent Tool
title: lookup_data_quality_scorecard_runbook
...
Look up sections of the Data Quality Scorecard Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_data_quality_scorecard_runbook(section_anchor=<section_anchor>)
```
