---
type: Agent Tool
title: lookup_bid_evaluation_scenario_analyzer_policy_guide
...
Look up sections of the Bid Evaluation & Scenario Analyzer Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [multi_criteria_scoring_scenarios](/workflow/multi-criteria-scoring-scenarios.md)
...
```
lookup_bid_evaluation_scenario_analyzer_policy_guide(section_anchor=<section_anchor>)
```
