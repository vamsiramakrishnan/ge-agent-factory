...
description: Retrieve inventory snapshots from Manhattan Active WM for the DC Labor Planning Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve inventory snapshots from Manhattan Active WM for the DC Labor Planning Engine workflow.
