...
description: Retrieve pick tasks from Manhattan Active WM for the DC Labor Planning Engine workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve pick tasks from Manhattan Active WM for the DC Labor Planning Engine workflow.
