---
type: Agent Tool
title: lookup_category_strategy_generator_policy_guide
...
Look up sections of the Category Strategy Generator Procurement Policy Guide to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_category_strategy_generator_policy_guide(section_anchor=<section_anchor>)
```
