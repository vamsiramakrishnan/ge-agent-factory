...
description: Retrieve analytics events from BigQuery for the Truck Roll Avoidance Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Truck Roll Avoidance Agent workflow.
