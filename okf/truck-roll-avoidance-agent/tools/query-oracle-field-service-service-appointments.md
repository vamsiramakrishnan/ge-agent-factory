...
description: Retrieve service appointments from Oracle Field Service for the Truck Roll Avoidance Agent workflow.
tags:
  - telco
  - okf
  - brd
...
Retrieve service appointments from Oracle Field Service for the Truck Roll Avoidance Agent workflow.
