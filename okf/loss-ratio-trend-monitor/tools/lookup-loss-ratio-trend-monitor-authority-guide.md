---
type: Agent Tool
title: lookup_loss_ratio_trend_monitor_authority_guide
description: "Look up sections of the Loss Ratio Trend Monitor Authority & Referral Guide to cite in narrative output, escalation rationale, and audit evidence."
tags:
  - insurance
  - okf
  - brd
...
# lookup_loss_ratio_trend_monitor_authority_guide

Look up sections of the Loss Ratio Trend Monitor Authority & Referral Guide to cite in narrative output, escalation rationale, and audit evidence.
...
- [credibility_weighted_trend_confirmation](/workflow/credibility-weighted-trend-confirmation.md)
...
```
lookup_loss_ratio_trend_monitor_authority_guide(section_anchor=<section_anchor>)
```
