...
description: Retrieve analytics events from BigQuery for the Loss Ratio Trend Monitor workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Loss Ratio Trend Monitor workflow.
