...
description: Retrieve circular updates from Verisk ISO ERC for the Loss Ratio Trend Monitor workflow.
tags:
  - insurance
  - okf
  - brd
...
Retrieve circular updates from Verisk ISO ERC for the Loss Ratio Trend Monitor workflow.
