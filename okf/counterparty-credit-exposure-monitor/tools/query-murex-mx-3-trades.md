...
description: Retrieve trades from Murex MX.3 for the Counterparty Credit Exposure Monitor workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve trades from Murex MX.3 for the Counterparty Credit Exposure Monitor workflow.
