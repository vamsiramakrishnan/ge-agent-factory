...
description: Retrieve dashboards from Looker for the Counterparty Credit Exposure Monitor workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve dashboards from Looker for the Counterparty Credit Exposure Monitor workflow.
