...
description: Retrieve analytics events from BigQuery for the Counterparty Credit Exposure Monitor workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Counterparty Credit Exposure Monitor workflow.
