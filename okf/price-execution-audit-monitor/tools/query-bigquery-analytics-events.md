...
description: Retrieve analytics events from BigQuery for the Price Execution Audit Monitor workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve analytics events from BigQuery for the Price Execution Audit Monitor workflow.
