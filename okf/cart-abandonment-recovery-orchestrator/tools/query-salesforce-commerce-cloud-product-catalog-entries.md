...
description: Retrieve product catalog entries from Salesforce Commerce Cloud for the Cart Abandonment Recovery Orchestrator workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve product catalog entries from Salesforce Commerce Cloud for the Cart Abandonment Recovery Orchestrator workflow.
