...
description: Retrieve cart events from Salesforce Commerce Cloud for the Cart Abandonment Recovery Orchestrator workflow.
tags:
  - retail
  - okf
  - brd
...
Retrieve cart events from Salesforce Commerce Cloud for the Cart Abandonment Recovery Orchestrator workflow.
