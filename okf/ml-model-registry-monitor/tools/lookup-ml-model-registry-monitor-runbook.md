---
type: Agent Tool
title: lookup_ml_model_registry_monitor_runbook
...
Look up sections of the ML Model Registry & Monitor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
- [version_management](/workflow/version-management.md)
...
```
lookup_ml_model_registry_monitor_runbook(section_anchor=<section_anchor>)
```
