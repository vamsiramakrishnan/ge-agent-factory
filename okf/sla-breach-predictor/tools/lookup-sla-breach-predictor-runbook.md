---
type: Agent Tool
title: lookup_sla_breach_predictor_runbook
...
Look up sections of the SLA Breach Predictor Operations Runbook to cite in narrative output, escalation rationale, and audit evidence.
...
```
lookup_sla_breach_predictor_runbook(section_anchor=<section_anchor>)
```
