...
title: Look up the governing sections of the Overdraft Fee Dispute Triage Agent Bank...
description: "Look up the governing sections of the Overdraft Fee Dispute Triage Agent Banking Compliance Policy and the waiver authority playbook to decide refund versus denial, citing the specific thresholds and anchors that justify the outcome."
source_id: "policy-gated-refund-determination"
...
# Look up the governing sections of the Overdraft Fee Dispute Triage Agent Banking Compliance Policy and the waiver authority playbook to decide refund versus denial, citing the specific thresholds and anchors that justify the outcome.
