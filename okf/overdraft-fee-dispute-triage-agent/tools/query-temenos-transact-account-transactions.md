...
description: Retrieve account transactions from Temenos Transact for the Overdraft Fee Dispute Triage Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve account transactions from Temenos Transact for the Overdraft Fee Dispute Triage Agent workflow.
