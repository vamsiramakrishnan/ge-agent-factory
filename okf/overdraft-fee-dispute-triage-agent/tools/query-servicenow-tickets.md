...
description: Retrieve tickets from ServiceNow for the Overdraft Fee Dispute Triage Agent workflow.
tags:
  - banking
  - okf
  - brd
...
Retrieve tickets from ServiceNow for the Overdraft Fee Dispute Triage Agent workflow.
