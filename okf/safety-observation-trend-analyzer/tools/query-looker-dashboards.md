...
description: Retrieve dashboards from Looker for the Safety Observation Trend Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve dashboards from Looker for the Safety Observation Trend Analyzer workflow.
