...
description: Retrieve permit records from Sphera EHS for the Safety Observation Trend Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve permit records from Sphera EHS for the Safety Observation Trend Analyzer workflow.
