...
description: Retrieve emissions readings from Sphera EHS for the Safety Observation Trend Analyzer workflow.
tags:
  - manufacturing
  - okf
  - brd
...
Retrieve emissions readings from Sphera EHS for the Safety Observation Trend Analyzer workflow.
