...
| [`building-simulators`](building-simulators/) | `simulator_build` | `ge data synth`, `ge pipeline run`, `ge daemon start`, `ge systems profile`, `ge systems record`, `ge systems compare`, `ge systems mutation infer`, `ge systems mutation validate`, `ge systems mutation apply` | [`@ge/synthkit`](../packages/synthkit/), [`@ge/byo-systems`](../packages/byo-systems/) | [`synthetic-data.md`](../docs/reference/synthetic-data.md), [`simulator-systems.md`](../docs/reference/simulator-systems.md), [`bring-your-own-systems.md`](../docs/cookbooks/bring-your-own-systems.md), [`cli.md`](../docs/reference/cli.md) |
...
| [`authoring-okf-specs`](authoring-okf-specs/) | `knowledge_format` | `ge okf customize`, `ge agents register`, `ge agents track`, `ge okf skill` | [`@ge/okf`](../packages/okf/) | [`okf.md`](../docs/reference/okf.md), [`agent-lifecycle.md`](../docs/reference/agent-lifecycle.md) |
| [`bringing-your-own`](bringing-your-own/) | `byo_customization` | `ge byo doctor`, `ge byo apply`, `ge systems bind`, `ge systems bindings`, `ge systems unbind`, `ge systems synth`, `ge systems doctor --dial`, `ge systems dispatch`, `ge systems profile`, `ge systems record`, `ge systems compare`, `ge systems mutation infer`, `ge systems mutation validate`, `ge systems mutation apply`, `ge evals import`, `ge models doctor`, `ge systems list`, `ge systems doctor` | [`@ge/byo-systems`](../packages/byo-systems/) | [`bring-your-own-systems.md`](../docs/cookbooks/bring-your-own-systems.md), [`cli.md`](../docs/reference/cli.md) |
...
| [`browsing-the-library`](browsing-the-library/) | — | `ge library stats`, `ge library search`, `ge library inspect`, `ge library status`, `ge create` | [`@ge/blueprint-library`](../packages/blueprint-library/) | [`cli.md`](../docs/reference/cli.md) |
| [`enriching-okf-blueprints`](enriching-okf-blueprints/) | — | `ge okf quality audit`, `ge okf enrich plan`, `ge okf enrich generate`, `ge okf enrich apply`, `ge okf enrich shard`, `ge okf eval verify`, `ge improve` | — | [`enrichment-rules.md`](enriching-okf-blueprints/references/enrichment-rules.md) |
