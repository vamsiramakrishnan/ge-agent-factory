...
const GE_INIT_NO_PROJECT_MESSAGE = "No project. Pass --project or run `gcloud config set project …`.";
...
function shouldPromptForInitProject(error, args, { isTTY = Boolean(process.stdin.isTTY && process.stdout.isTTY) } = {}) {
...
// gating below). Guarded so importing this module for tests doesn't also run
// the CLI against the test runner's own argv.
