...
const SUBCOMMANDS = new Set(["capture", "prove", "handoff", "passport", "status", "drive", "bench", "evals", "up", "doctor", "init", "cutover", "mode", "devex", "config", "infra", "images", "data", "mcp", "console", "agents", "pipeline", "fleet", "runs", "daemon", "state", "ledger", "apply", "okf", "library", "systems", "byo", "models", "create", "completions", "harness"]);
