...
const SUBCOMMANDS = new Set(["up", "doctor", "init", "cutover", "mode", "config", "infra", "images", "data", "mcp", "agents", "autopilot", "mission", "journey", "daemon", "runtime", "state", "ledger", "apply"]);
const root = defineCommand({
  ...
  subCommands: {
    // lifecycle
    up, doctor, init, cutover, mode, config,
    // noun groups
