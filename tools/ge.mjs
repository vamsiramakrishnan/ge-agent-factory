...
import { passport } from "./ge/passport.mjs";
...
import { completions } from "./ge/completions.mjs";
...
import { harness } from "./ge/harness.mjs";
import { improve } from "./ge/improve.mjs";
...
const SUBCOMMANDS = new Set(["capture", "prove", "handoff", "passport", "status", "drive", "bench", "evals", "up", "doctor", "init", "cutover", "mode", "devex", "config", "infra", "images", "data", "mcp", "console", "agents", "pipeline", "fleet", "runs", "daemon", "state", "ledger", "apply", "okf", "library", "systems", "byo", "models", "create", "completions", "harness", "improve"]);
